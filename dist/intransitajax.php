                ...
                <div class="card card-custom">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="intransit.php">Intransit</a>
                            </li>
                            <li class="nav-item">
                ...
                ?>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="intransit" class="container tab-pane active"><br>
                            ...
                            ?>
                                <div class="table-responsive">
                                    <table class="table table-separate table-head-custom table-checkable" id="example11">
                                        <thead>
                                            <tr>
                                                <th>S.No</th>
                                                <th>Name</th>
 ...
 <script>
        $(document).ready(function() {
            $('#example1').DataTable({
                ...
                "responsive": true,
                "ajax": {
                    "url": "ajax_request.php?action=fetch_branch_detail1",
                    "type": "POST"
                },
                "columns": [{
                        "data": "si_no"
