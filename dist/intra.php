                ...
                <div class="card card-custom">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#intransit">Intransit</a>
                            </li>
                            <li class="nav-item">
                        ...
                        ?>
                            <div class="tab-content">
                                ...
                                <div id="intransit" class="container tab-pane active"><br>
                                    <div class="card-body">
                                        <form method="post">
                                    ...
                                    ?>
                                        <div class="table-responsive">
                                            <table class="table table-separate table-head-custom table-checkable" id="example1">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $sql5 = "SELECT * FROM base where consignment_type !='month' AND customer_type !='party' AND delivery_status !='delivered' order by id desc ";
                                                    $result5 = $conn->query($sql5);
                                                    $j = 1;
                                                    while ($withoutdelivery = $result5->FETCH_ASSOC()) {
                                                    ?>
                                                        <tr id="filter_withoutdelivery">
                                                            <td><?php echo $j++ ?></td>
                                                            <td><a href="lrform_detail.php?id=<?php echo  $withoutdelivery["id"] ?>"><?php echo $withoutdelivery["from_name"] ?></a></td>
                                                            <td><?php echo $withoutdelivery["createdAt"] ?></td>
                                                            <td><?php echo $withoutdelivery["total"] ?></td>
                                                            <td><?php echo $withoutdelivery["balanceadd"] ?></td>
                                                            <td><?php echo $withoutdelivery["balance"] ?></td>
                                                            <?php
                                                            if ($withoutdelivery["mode_transport"] == '') {
                                                            ?>
                                                            ...
                                                            ?>
                                                            <?php
                                                            if ($withoutdelivery["delivery_status"] == 'delivered') {
                                                            ?>
                                                            ...
                                                            ?>
                                                            <?php
                                                            if ($withoutdelivery["consignment_type"] == "paid" || $withoutdelivery["balance"] == 0) {
                                                            ?>
                                    ...
                                    ?>
                                            <div class="table-responsive">
                                                <table class="table table-separate table-head-custom table-checkable" id="kt_datatable3">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $sql5 = "SELECT * FROM base where consignment_type !='month' AND customer_type !='party' AND delivery_status !='delivered' AND createddate >='$fromdate1' AND createddate <='$todate1' order by id desc";
                                                        $result5 = $conn->query($sql5);
                                                        $j = 1;
                                                        while ($withoutdelivery = $result5->FETCH_ASSOC()) {
                                                        ?>
                                ...
                                <div id="delivered" class="container tab-pane"><br>
                                    <div class="card-body">
                                        <form method="post">
                                            <div class="row mt-3 text-center">
                                                <div class="col-sm-4">
                                                    <label class="form-label">From Date</label>
                                                    <input class="form-control" type="date" name="fromdate2" id="fromdate2">
                                                </div>
                                                <div class="col-sm-4">
                                                    <label class="form-label">To Date</label>
                                                    <input class="form-control" type="date" name="todate2" id="todate2">
                                                </div>
                                                <div class="col-sm-4">
                                                    <input class="btn btn-primary m-5 pt-3" type="submit" name="filter2" value="Search" id="filter2">
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <?php
                                    $fromdate2 = isset($_POST['fromdate2']) ? $_POST['fromdate2'] : "";
                                    $todate2 = isset($_POST['todate2']) ? $_POST['todate2'] : "";
                                    ...
                                    ?>
                                        <div class="table-responsive">
                                            <table class="table table-separate table-head-custom table-checkable" id="example2">
                                                ...
                                                <tbody id="filter_delivery">
                                                    <?php
                                                    $sql6 = "SELECT * FROM base where consignment_type !='month' AND customer_type !='party' AND delivery_status='delivered' order by id desc";
                                                    $result6 = $conn->query($sql6);
                                                    $j = 1;
                                                    while ($withdelivery = $result6->FETCH_ASSOC()) {
                                                    ?>
                                                        <tr>
                                                            <td><?php echo $j++ ?></td>
                                                            <td><a href="lrform_detail.php?id=<?php echo  $withdelivery["id"] ?>"><?php echo $withdelivery["from_name"] ?></a></td>
                                                            <td><?php echo $withdelivery["createdAt"] ?></td>
                                                            <td><?php echo $withdelivery["total"] ?></td>
                                                            <td><?php echo $withdelivery["balanceadd"] ?></td>
                                                            <td><?php echo $withdelivery["balance"] ?></td>
                                                            <?php
                                                            if ($withdelivery["mode_transport"] == '') {
                                                            ?>
                                                                <td><span class="btn btn-sm btn-light-danger font-weight-bolder">Unloaded</span></td>
                                                            <?php
                                                            } else {
                                                            ...
                                                            ?>
                                                            <?php
                                                            if ($withdelivery["delivery_status"] == 'delivered') {
                                                            ?>
                                                                <td><span class="btn btn-sm btn-light-primary font-weight-bolder">Delivered</span></td>
                                                            <?php
                                                            } else {
                                                            ...
                                                            ?>
                                                            <?php
                                                            if ($withdelivery["consignment_type"] == "paid" ||  $withdelivery["balance"] == 0) {
                                                            ?>
                                                                <td><span class="btn btn-sm btn-light-primary font-weight-bolder">Paid</span></td>
                                                            <?php
                                                            } else {
                                    ...
                                    ?>
                                            <div class="table-responsive">
                                                <table class="table table-separate table-head-custom table-checkable" id="kt_datatable5">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $sql6 = "SELECT * FROM base where consignment_type !='month' AND customer_type !='party' AND delivery_status ='delivered' AND createddate >='$fromdate2' AND createddate<='$todate2' order by id desc";
                                                        $result6 = $conn->query($sql6);
                                                        $j = 1;
                                                        while ($withdelivery = $result6->FETCH_ASSOC()) {
                                                        ?>
                                ...
                                <div id="paid" class="container tab-pane"><br>
                                    <div class="card-body">
                                        <form method="post">
                                            <div class="row mt-3 text-center">
                                                <div class="col-sm-4">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-separate table-head-custom table-checkable" id="example3">
                                                ...
                                                <tbody id="filter_paid">
                                                    <?php
                                                    $sql7 = "SELECT * FROM base where consignment_type !='month' AND customer_type !='party' AND ( balance='0' || consignment_type = 'paid' ) order by id desc";
                                ...
                                <div id="unpaid" class="container tab-pane"><br>
                                    <div class="card-body">
                                        <form method="post">
                                            <div class="row mt-3 text-center">
                                                <div class="col-sm-4">
                                                    <label class="form-label">From Date</label>
                                                    <input class="form-control" type="date" name="fromdate4" id="fromdate4">
                                                </div>
                                                <div class="col-sm-4">
                                                    <label class="form-label">To Date</label>
                                                    <input class="form-control" type="date" name="todate4" id="todate4">
                                                </div>
                                                <div class="col-sm-4">
                                                    <input class="btn btn-primary m-5 pt-3" type="submit" name="filter4" value="Search" id="filter4">
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <?php
                                    $fromdate4 = isset($_POST['fromdate4']) ? $_POST['fromdate4'] : "";
                                    $todate4 = isset($_POST['todate4']) ? $_POST['todate4'] : "";
                                    ...
                                    ?>
                                        <div class="table-responsive">
                                            <table class="table table-separate table-head-custom table-checkable" id="example4">
                                                ...
                                                <tbody id="filter_unpaid">
                                                    <?php
                                                    $sql8 = "SELECT * FROM base where customer_type !='party' AND consignment_type !='month' AND 'paid' || balance !='0'  order by id  desc";
                                                    $result8 = $conn->query($sql8);
                                                    $j = 1;
                                                    while ($unpaid = $result8->FETCH_ASSOC()) {

                                                    ?>
                                                        <tr>
                                                            <td><?php echo $j++ ?></td>
                                                            <td><a href="lrform_detail.php?id=<?php echo $unpaid["id"] ?>"><?php echo $unpaid["from_name"] ?></a></td>
                                                            <td><?php echo $unpaid["createdAt"] ?></td>
                                                            <td><?php echo $unpaid["total"] ?></td>
                                                            <td><?php echo $unpaid["balanceadd"] ?></td>
                                                            <td><?php echo $unpaid["balance"] ?></td>
                                                            <?php
                                                            if ($unpaid["mode_transport"] == '') {
                                                            ?>
                                                                <td><span class="btn btn-sm btn-light-danger font-weight-bolder">Unloaded</span></td>
                                                            <?php
                                                            } else {
                                                            ...
                                                            ?>
                                                            <?php
                                                            if ($unpaid["delivery_status"] == 'delivered') {
                                                            ?>
                                                                <td><span class="btn btn-sm btn-light-primary font-weight-bolder">Delivered</span></td>
                                                            <?php
                                                            } else {
                                                            ...
                                                            ?>
                                                            <?php
                                                            if ($unpaid["consignment_type"] == "paid" || $unpaid["balance"] == 0) {
                                                            ?>
                                                                <td><span class="btn btn-sm btn-light-primary font-weight-bolder">Paid</span></td>
                                                            <?php
                                                            } else {
                                    ...
                                    ?>
                                            <div class="table-responsive">
                                                <table class="table table-separate table-head-custom table-checkable" id="kt_datatable9">
                                                    <thead>
                                                        <tr>
                                                            <th>S.No</th>
                                                            <th>Name</th>
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $sql8 = "SELECT * FROM base where createddate >='$fromdate4' AND createddate <='$todate4' AND customer_type !='party' AND consignment_type !='month' AND 'paid' || balance !='0' order by id desc";
                                                        $result8 = $conn->query($sql8);
                                                        $j = 1;
                                                        while ($unpaid = $result8->FETCH_ASSOC()) {
                            ...
                            ?>
                                <div class="table-responsive">
                                    <table class="table table-separate table-head-custom table-checkable" id="example1">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql5 = "SELECT * FROM base where delivery_status !='delivered' && branch = '$branch' && username = '$username' AND consignment_type !='month' AND customer_type !='party' order by id desc ";
                                            $result5 = $conn->query($sql5);
                                            $j = 1;
                                            while ($withoutdelivery = $result5->FETCH_ASSOC()) {
                                                //  $id=$withoutdelivery["id"];
                                                // $sql6 = "SELECT * FROM base where id=$id";
                                                // $result6 = $conn->query($sql6);
                                                // $withoutdelivery6= $result6->FETCH_ASSOC();
                                            ?>
                                                <tr id="filter_withoutdelivery">
                                                    <td><?php echo $j++ ?></td>
                                                    <td><a href="lrform_detail.php?id=<?php echo  $withoutdelivery["id"] ?>"><?php echo $withoutdelivery["from_name"] ?></a></td>
                            ...
                            ?>
                                    <div class="table-responsive">
                                        <table class="table table-separate table-head-custom table-checkable" id="kt_datatable3">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql5 = "SELECT * FROM base where customer_type !='party' AND delivery_status !='delivered' AND createddate >='$fromdate1' AND createddate<='$todate1' AND branch = '$branch' && username = '$username' order by id desc";
                                                $result5 = $conn->query($sql5);
                                                $j = 1;
                                                while ($withoutdelivery = $result5->FETCH_ASSOC()) {
                                                ?>
                            ...
                            ?>
                                <div class="table-responsive">
                                    <table class="table table-separate table-head-custom table-checkable" id="example2">
                                        ...
                                        <tbody id="filter_delivery">
                                            <?php
                                            $sql6 = "SELECT * FROM base where delivery_status='delivered' && branch = '$branch' && username = '$username' && consignment_type !='month' && customer_type !='party' order by id desc";
                                            $result6 = $conn->query($sql6);
                                            $j = 1;
                                            while ($withdelivery = $result6->FETCH_ASSOC()) {
                                                //  $id=$withdelivery["id"];
                                                //  $sql7 = "SELECT * FROM base where id=$id";
                                                // $result7 = $conn->query($sql7);
                                                // $withdelivery7 = $result7->FETCH_ASSOC();
                                            ?>
                                                <tr>
                                                    <td><?php echo $j++ ?></td>
                                                    <td><a href="lrform_detail.php?id=<?php echo  $withdelivery["id"] ?>"><?php echo $withdelivery["from_name"] ?></a></td>
                            ...
                            ?>
                                    <div class="table-responsive">
                                        <table class="table table-separate table-head-custom table-checkable" id="kt_datatable5">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql6 = "SELECT * FROM base where delivery_status ='delivered' AND createddate >='$fromdate2' AND createddate<='$todate2' && branch = '$branch' && username = '$username' && consignment_type !='month' AND customer_type !='party' order by id desc";
                                                $result6 = $conn->query($sql6);
                                                $j = 1;
                                                while ($withdelivery = $result6->FETCH_ASSOC()) {
                                                ?>
                            ...
                            ?>
                                <div class="table-responsive">
                                    <table class="table table-separate table-head-custom table-checkable" id="example4">
                                        ...
                                        <tbody id="filter_unpaid">
                                            <?php
                                            // 			$sql8 = "SELECT * FROM base where consignment_type !='month' AND customer_type !='party' AND branch = '$branch' && username = '$username' && (consignment_type!='paid' || balance!=0) order by id desc";
                                            $sql8 = "SELECT * FROM base where customer_type !='party' AND consignment_type !='month' AND 'paid' || balance !='0' AND branch = '$branch' && username = '$username' order by id desc";
                                            $result8 = $conn->query($sql8);
                                            $j = 1;
                                            while ($unpaid = $result8->FETCH_ASSOC()) {
                            ...
                            ?>
                                    <div class="table-responsive">
                                        <table class="table table-separate table-head-custom table-checkable" id="kt_datatable9">
                                            ...
                                            <tbody>
                                                <?php
                                                // $sql8 = "SELECT * FROM base where consignment_type !='month' AND customer_type !='party' AND (consignment_type!='paid' || balance!=0) AND createddate >='$fromdate4' AND createddate<='$todate4' && branch = '$branch' && username = '$username' order by id desc";
                                                $sql8 = "SELECT * FROM base where createddate >='$fromdate4' AND createddate<='$todate4' && branch = '$branch' && username = '$username' AND customer_type !='party' AND consignment_type !='month' AND 'paid' || balance !='0' order by id desc";
                                                $result8 = $conn->query($sql8);
                                                $j = 1;
                                                while ($unpaid = $result8->FETCH_ASSOC()) {
