...
//     $sql2 = "update booking_from set Complaint_id='$Complaint_id' where id=$id";
...
if(isset($_POST['upload_excel'])){
    ...
    //             $prevQuery = "SELECT * FROM booking_from";
    //             $prevResult = $con->query($prevQuery);
			...
			if($customer_type=="Customer") {
	            ...
	            $conn->query("INSERT into base (createdAt,booking_mode,courier_mode,customer_id,username,consignee_name,booking_number,destination,weight,volume_weight,risk_charge,balanceadd1,pymt_date,paid_viya,product_value,status,out_status,In_transit,rto_status,notdev_status,des_status,updatedAt,Complaint_id,delivery_date,customer_type,updated_by) values('".$createdAt."','".$booking_mode."','".$courier_mode."','".$customer_id."','".$username."','".$consignee_name."','".$booking_number."','".$destination."','".$weight."','".$volume_weight."','".$risk_charge."','".$amount."','".$pymt_date."','".$paid_viya."','".$product_id."','".$status."','".$out_status."','".$In_transit."','".$rto_status."','".$notdev_status."','".$des_status."','".$updatedAt."','".$Complaint_id."','$delivery_date','$customer_type','Admin')");
	  	}
            }
...
// $(document).on('click','#doc_id',function(e){
//         e.preventDefault();
//           id = $('#docid').val();
//           docsup = $('#docsid').val();
// // alert(id)
                                    ...
                                    <tr class='col-sm-12 d-flex justify-content-center text-center'>
                                        <th colspan='22'>
                                            ...
                                            <tr class='col-sm-12 d-flex justify-content-center text-center'>
                                                ...
                                                <!--<tr>-->
                                                <!--    <th colspan='20'>-->
                                                <!--        <h4>&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;<strong>Address</strong></h4>-->
                                                <!--    </th>-->
                                                <!--</tr>-->
                                                <!--<tr>-->
                                                <!--    <th colspan='20'>-->
                                                <!--        <h2>&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;TEL NO:- 044-000000000,MOB NO:-9874563210,E-Mail:-demo@gmail.com</h2>-->
                                                <!--    </th>-->
                                                <!--</tr>-->
                                                <tr>
                                                       <th>S.No</th>
...
//         // alert(role)
//       $.ajax ({
//                   "url": "ajax_request.php?action=fetch_branch_detaildb&role="+role,
//                 "type": "POST",
//             // data: { hps_level: '' + level + '' },
//                 success : function(htmlresponse) {
//                         // table.ajax.reload(null, false); // null, false 
//                                      $('#bookingdb').DataTable().ajax.reload(null, false)
...
//   });
    ...
    $(document).ready(function() {
        var table = $('#bookingdb').DataTable({
            ...
            "responsive": true,
            "ajax": {
                "url": "ajax_request.php?action=fetch_branch_detaildbp",
                "type": "POST"
            },
            "columns": [{
                    "data": "si_no"
        ...
        $("#filterall").on("click", function() {
            ...
            if (from != "" && to != "") {
                table.ajax.url("ajax_request.php?action=fetch_branch_detaildbp&from=" + from + '&to=' + to).load();
                table.ajax.reload();
            } else {
                table.ajax.url("ajax_request.php?action=fetch_branch_detaildbp").load();
                table.ajax.reload();
            }
           ...
           var role=  $('#role :selected').val();
            if(role!=""){
                table.ajax.url("ajax_request.php?action=fetch_branch_detaildbp&role="+role).load();
                table.ajax.reload();
            } 
            else{
               table.ajax.url("ajax_request.php?action=fetch_branch_detaildbp").load();
           ...
           $("#courier").on("change",function(){
            ...
            //   alert(courier)
        if(courier!=""){
                table.ajax.url("ajax_request.php?action=fetch_branch_detaildbp&courier="+courier).load();
                table.ajax.reload();
            } 
            else{
               table.ajax.url("ajax_request.php?action=fetch_branch_detaildbp").load();
            ...
            //   alert(courier)
        if(name!=""){
                table.ajax.url("ajax_request.php?action=fetch_branch_detaildbp&name="+name).load();
                table.ajax.reload();
            } 
            else{
               table.ajax.url("ajax_request.php?action=fetch_branch_detaildbp").load();
...
var names=$("#namea").val();
 ...
 if(row.updated_by=="Admin") {
    ...
    $("#filterall").on("click", function() {
        ...
        if (from != "" && to != "") {
            tableall.ajax.url("ajax_request.php?action=fetch_branch_detaildbp&from=" + from + '&to=' + to).load();
            tableall.ajax.reload();
        } else {
            tableall.ajax.url("ajax_request.php?action=fetch_branch_detaildbp").load();
            tableall.ajax.reload();
        }
...
<script>
  ...
  $('#bookingrto').on('click', '.delete_user', function() {
   ...
   $('#bookingnotdelivered').on('click', '.delete_user', function() {
    ...
    //   $('#bookingdb').on('click', '.undeli_review', function() {
    //         var id = $(this).attr('id');
    //         // alert(id)
    //         $.ajax({
    //             type: "POST",
    ...
    //         })
    //     });
    //     $('#bookingdb').on('click', '.deli_review', function() {
    //         var id = $(this).attr('id');
    //         // alert(id)
    //         $.ajax({
    //             type: "POST",
    ...
    //     $('#bookingdb').on('click', '.out_review', function() {
    //         var id = $(this).attr('id');
    //         // alert(id)
    //         $.ajax({
    //             type: "POST",
    ...
    //         })
    //     });
    //     $('#bookingdb').on('click', '.unout_review', function() {
    //         var id = $(this).attr('id');
    //         // alert(id)
    //         $.ajax({
    //             type: "POST",
    ...
    //     $('#bookingdb').on('click', '.intra_review', function() {
    //         var id = $(this).attr('id');
    //         // alert(id)
    //         $.ajax({
    //             type: "POST",
    ...
    //         })
    //     });
    //     $('#bookingdb').on('click', '.unintra_review', function() {
    //         var id = $(this).attr('id');
    //         // alert(id)
    //         $.ajax({
    //             type: "POST",
    ...
    //     $('#bookingdb').on('click', '.rto_review', function() {
    //         var id = $(this).attr('id');
    //         // alert(id)
    //         $.ajax({
    //             type: "POST",
    ...
    //         })
    //     });
    //     $('#bookingdb').on('click', '.unrto_review', function() {
    //         var id = $(this).attr('id');
    //         // alert(id)
    //         $.ajax({
    //             type: "POST",
    ...
    //     $('#bookingdb').on('click', '.notdeli_review', function() {
    //         var id = $(this).attr('id');
    //         // alert(id)
    //         $.ajax({
    //             type: "POST",
    ...
    //         })
    //     });
    //     $('#bookingdb').on('click', '.unnotdeli_review', function() {
    //         var id = $(this).attr('id');
    //         // alert(id)
    //         $.ajax({
    //             type: "POST",
    ...
    //     $('#bookingdb').on('click', '.reachdest_review', function() {
    //         var id = $(this).attr('id');
    //         // alert(id)
    //         $.ajax({
    //             type: "POST",
    ...
    //         })
    //     });
    //     $('#bookingdb').on('click', '.unreachdest_review', function() {
    //         var id = $(this).attr('id');
    //         // alert(id)
    //         $.ajax({
    //             type: "POST",
...
<script>
    $(document).ready(function() {
        // $('#bookingdbuser').on('click', '.complaintdetail', function() {
        //     var id = $(this).attr('id');
        //     // alert(id)
