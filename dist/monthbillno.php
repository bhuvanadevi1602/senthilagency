...
// session_start();
// $id = $_GET['id'];
$monthbill_id = $_GET['monthbill_id'];
					...
					<div class="card-body">
						...
						?>
							...
							<div class="row mt-3 text-center">
								...
								<div class="col-sm-2">
									<a href="#" class="btn btn-light-danger font-weight-bold" onclick="history.go(-1)">Back</a>
								</div>
							</div>
							...
							<div class="table-responsive">
								<table class="table table-separate table-head-custom table-checkable" id="example7">
									...
									<tbody>
										...
										$sql5 = "SELECT * FROM base where company_name='$company_name' AND monthstatus=1 AND monthbill_id='$monthbill_id'";
										...
										?>
											<tr>
												...
												<td><?php echo $delivery["balance2"] ?></td>
											</tr>
										<?php
										}
										?>
								...
								<table style="display:none" class="table table-separate table-head-custom table-checkable" id="example6">
									...
									<tbody id="filter_month">
										...
										while ($delivery = $result5->FETCH_ASSOC()) {
											...
											$amount_paid = $delivery["amount_paid2"];
										?>
											<tr>
												<td id="filter_id"><?php echo $j++ ?></td>
												<td><?php echo $delivery["createdAt"] ?></td>
												<td><?php echo $delivery["company_name"] ?></a></td>
												...
												<td><?php echo $delivery["total"] ?></td>
												<td><?php echo $delivery["amount_paid2"] ?></td>
												<td><?php echo $delivery["total"] - $delivery["amount_paid2"] ?></td>
											</tr>
										<?php
										}
										?>
							...
							<div class="table-responsive">
								<table class="table table-separate table-head-custom table-checkable" id="example7">
									...
									<tbody>
										...
										$sql5 = "SELECT * FROM base where company_name='$company_name' AND monthstatus=1 AND monthbill_id='$monthbill_id' && branch = '$branch'";
										$result5 = $conn->query($sql5);
										$j = 1;
										$s = 0;
										$s1 = 0;
							...
							<div class="table-responsive">
								<table class="table table-separate table-head-custom table-checkable" id="example7">
									...
									<tbody>
										...
										$sql5 = "SELECT * FROM base where company_name='$company_name' AND monthstatus=1 AND monthbill_id='$monthbill_id' && branch = '$branch' && username = '$username'";
										$result5 = $conn->query($sql5);
										$j = 1;
										$s = 0;
										$s1 = 0;
...
<script>
	$(document).ready(function() {
		$('.allloading_branch').on('click', function() {
			...
			// 			var partydata = $('#allloading_user_id').val(id);
			// 			alert(partydata)
