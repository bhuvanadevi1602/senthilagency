...
<div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
    ...
    <div class="alert-text">
        Metronic extends <code>Bootstrap Modal</code> component with a variety of options to provide unique looking Modal components that matches Metronic's design standards.
        <br/>
        For more info on Bootstrap Modal please visit the official
        <a class="font-weight-bold" href="https://getbootstrap.com/docs/4.3/components/modal/" target="_blank">Bootstrap Documentation</a>.
    </div>
</div>
<!--end::Notice-->
            ...
            <div class="card-body">
                ...
                <div class="example">
                    ...
                    <div class="example-preview">
                        <div class="modal position-relative d-block" style="z-index: 0" tabindex="-1" role="dialog">
        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-body">
                ...
                <div class="example">
                    ...
                    <div class="example-preview">
                        <!-- Button trigger modal-->
                        <button type="button" class="btn btn-primary mr-2" data-toggle="modal" data-target="#exampleModalSizeSm">
                            Modal - sm
                        </button>

                        <button type="button" class="btn btn-primary mr-2" data-toggle="modal" data-target="#exampleModalSizeDefault">
                            Modal - default
                        </button>
                        ...
                        <button type="button" class="btn btn-primary mr-2" data-toggle="modal" data-target="#exampleModalSizeXl">
                            Modal - xl
                        </button>
    ...
    <div class="col-xl-6">
        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-body">
                ...
                <div class="example mb-10">
                    <p>
                        Create a scrollable modal body by adding <code>.modal-dialog-scrollable</code> to <code>.modal-dialog</code>.
                    </p>
                    <div class="example-preview">
                        <!-- Button trigger modal-->
                ...
                <div class="example">
                    <p>
                        Add <code>data-scroll="true"</code> and <code>data-height="300"</code> attributes to <code>.modal-body</code> to use <a href="" class="font-weight-bold">Perfect Scrollbar</a> based scrolling.
                    </p>
                    <div class="example-preview">
                        <!-- Button trigger modal-->
                        ...
                        <!-- Modal-->
                        <div class="modal fade" id="exampleModalCustomScrollable" tabindex="-1" role="dialog" aria-labelledby="exampleModalCustomScrollable" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Modal Title</h5>
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <p>
                                            This <a href="#" role="button" class="btn btn-secondary" data-toggle="popover" title="Popover title" data-content="Popover body content is set in this attribute.">button</a>
