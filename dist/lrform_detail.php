...
$sql2 = "SELECT * FROM delivery WHERE id='$id' ";
...
if (isset($_POST['register'])) {
    ...
    if (mysqli_query($conn, $insert)) {
        ...
        $agent = "agent_name";
        if ($from == "from_name") {
            $stext =  rawurlencode("Dear $from_name, Your consignment bearing LR No. $lr_no has been successfully delivered. For more details contact us on 9382586897. Regards, APS Cargo Movers");
            ...
            $data = array('apikey' => $apiKey, 'sender' => $sender);

            $url = 'https://www.smsgatewayhub.com/api/mt/SendSMS?APIKey=' . $data["apikey"] . '&senderid=' . $data["sender"] . '&channel=2&DCS=0&flashsms=0&number=91' . $from_number . '&text=' . $stext . '&route=31&EntityId=1201161889896722595&dlttemplateid=1207166158876293756';
        ...
        if ($agent == "agent_name") {
            ...
            $stext =  rawurlencode("Dear $agent_name, Your consignment bearing LR No. $lr_no has been successfully delivered. For more details contact us on 9382586897. Regards, APS Cargo Movers");
            $sender = urlencode('APSCAR');
            ...
            $url = 'https://www.smsgatewayhub.com/api/mt/SendSMS?APIKey=' . $data["apikey"] . '&senderid=' . $data["sender"] . '&channel=2&DCS=0&flashsms=0&number=91' . $agent_number . '&text=' . $stext . '&route=31&EntityId=1201161889896722595&dlttemplateid=1207166158876293756';
        ...
        echo "<script>window.location.href='lrform_detail.php?id=$id';</script>";
    }
}
...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_query($conn, $insert)) {
        $sql2 = "UPDATE add_branch SET branch_balance = (branch_balance+'$amount_paid') WHERE branch_name= '$userBranch'";
        if ($conn->query($sql2)) {
            ...
            $sql3 = "INSERT INTO transaction_history (branch_id,user_id,username,category,description,Amount,credit,debit,balance) 
            VALUES ('$branch_id','$userId','$username','Payments','','$pettyCashAmount','$amount_paid',0,'$branch_balance')";
            $conn->query($sql3);
        }
...
if (isset($_POST['register_to'])) {
    ...
    $update_otp = "UPDATE base SET to_name='$to_name',to_address='$to_address',to_contact='$to_contact' where id='$id'";
...
if (isset($_POST['register_form'])) {
    ...
    $update = "UPDATE base SET from_name='$from_name', from_address='$from_address',from_contact='$from_contact' where id='$id'";
...
if (isset($_POST['register_agent'])) {
    ...
    $update_otp = "UPDATE base SET agent='$agent',agent_name='$agent_name', agent_city='$agent_city',agent_contact='$agent_contact',delivery_message='$delivery_message'
                     where id='$id'";

    $update_otp_sql = mysqli_query($conn, $update_otp); {
        //  echo '<script>alert("view_lr_branch.php")</script>' ;
        echo "<script>window.location.href='lrform_detail.php?id=$id';</script>";
    }
}

if (isset($_POST['tracking_reg'])) {
    $id = $_POST["id"];
    ...
    $update_otp = "UPDATE base SET mode_transport='$mode_transport',lorry_no='$lorry_no',train_type='$train_type',RR_No='$RR_No',train_No='$train_No',flight_no='$flight_no' where id='$id'";
...
<body id="kt_body" class="header-mobile-fixed subheader-enabled aside-enabled aside-fixed aside-secondary-enabled page-loading">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="card card-custom gutter-b  example-compact">
                                                    <div class="card-header">
                                                        <h3 class="card-title" style="color: #1BC5BD;"><b>Booking</b></h3>
                                                        
                                                        <div class="card-toolbar">
                                                            <div class="example-tools justify-content-center">

                                                                <a href="edit_booking_lrform.php?id=<?php echo $row['id'] ?>" class="btn btn-primary font-weight-bolder">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">Booking type </label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['booking_type']; ?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">LR No </label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['lr_no']; ?>
                                                            </div>
                                                        </div>
                                                        <!--<div class="form-group row">-->
                                                        <!--    <label class="col-lg-6 col-sm-12">Railway no </label>-->
                                                        <!--    <div class="col-lg-6 col-md-6 col-sm-12">-->
                                                        <!--        <?php echo $row['railway_no']; ?>-->
                                                        <!--    </div>-->
                                                        <!--</div>-->
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">Consignment Type </label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['consignment_type']; ?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">Company Name</label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['company_name']; ?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">Invoice No</label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['invoice_no']; ?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">Invoice Type </label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">Internal Info </label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <div id="showhide"></div>
                                                                <div id="hide_show">
                                                                    <?php echo $row['internal_info']; ?>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">Eway Bill No </label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['eway_bill']; ?>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">Material Name</label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">Quantity in KG </label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['quantity_kg']; ?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">Quantity in Nos </label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['quantity_nos']; ?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">Rate per unit </label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['rate']; ?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">Docket Charge</label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['docket_charge']; ?>
                                                            </div>
                                                        </div>
                                                        <!--<div class="form-group row">-->
                                                        <!--    <label class="col-lg-6 col-sm-12">CD Charge</label>-->
                                                        <!--    <div class="col-lg-6 col-md-6 col-sm-12">-->
                                                        <!--        <?php echo $row['cd_charge']; ?>-->
                                                        <!--    </div>-->
                                                        <!--</div>-->

                                                        <!--<div class="form-group row" id="optClass" style="display:none;" onchange="status1(this);">-->
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">GST</label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['gst']; ?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">GST value</label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['gstamount']; ?>
                                                            </div>
                                                        </div>
                                                        <!--<div class="form-group row" id="gstoptClass1" style="display:none;">-->
                                                        <!--    <label class="col-lg-6 col-sm-12">CGST% </label>-->
                                                        <!--    <div class="col-lg-6 col-md-6 col-sm-12">-->
                                                        <!--        <?php echo $row['cgst']; ?>-->
                                                        <!--    </div>-->
                                                        <!--    <label class="col-lg-6 col-sm-12">SGST% </label>-->
                                                        <!--    <div class="col-lg-6 col-md-6 col-sm-12">-->
                                                        <!--        <?php echo $row['sgst']; ?>-->
                                                        <!--    </div>-->
                                                        <!--</div>-->
                                                        <!--<div class="form-group row" id="gstoptClass2" style="display:none;">-->
                                                        <!--    <label class="col-lg-6 col-sm-12">IGST% </label>-->
                                                        <!--    <div class="col-lg-6 col-md-6 col-sm-12">-->
                                                        <!--        <?php echo $row['igst']; ?>-->
                                                        <!--    </div>-->
                                                        <!--</div>-->
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">Vehicle Halting Charge</label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['Vehicle_halting']; ?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">Unloading Charge</label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['unloading_charge']; ?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">Agent's Commission</label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                ...
                                                <div class="card card-custom gutter-b  example-compact">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">Bill amount</label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['bill_amount'] ?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">Sub Total</label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">CGST</label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['cgst_value'] ?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">SGST</label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['sgst_value'] ?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">IGST</label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['igst_value'] ?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">Total</label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['total'] ?>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-lg-6">
                                                                        ...
                                                                        <div class="modal-dialog" role="document">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <h5 class="modal-title" id="exampleModalLabel" style="color: #1BC5BD;"><b>Edit</b></h5>
                                                ...
                                                <div class="card card-custom gutter-b  example-compact">
                                                    <div class="card-header">
                                                        ...
                                                        <div class="card-toolbar">
                                                            <div class="example-tools justify-content-center">
                                                                <a href="#" class="btn btn-primary font-weight-bolder" data-toggle="modal" data-target="#exampleModal22">
                                                                    <span class="svg-icon svg-icon-md">
                                                                        <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Flatten.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                                <rect x="0" y="0" width="24" height="24" />
                                                                ...
                                                                <div class="modal fade" id="exampleModal22" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel22" aria-hidden="true">
                                                                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                                                                        <div class="modal-dialog" role="document">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <h5 class="modal-title" id="exampleModalLabel22" style="color:#1BC5BD"><b>Edit Tracking</b></h5>
                                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                        <i aria-hidden="true" class="ki ki-close"></i>
                                                                                    </button>
                                                                                </div>
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <div class="card-body">
                                                                                        ...
                                                                                        <div class="form-group row" onchange="status2(this);">
                                                                                            ...
                                                                                            <label class="col-form-label text-right col-lg-3 col-sm-12">Mode of Transport </label>
                                                                                            <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                                <select class="form-control" name="mode_transport" id="mode_transport">
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    <button type="submit" class="btn btn-primary font-weight-bold" name="tracking_reg" id="submit">Save</button>
                                                                                    <button type="button" class="btn btn-light-danger font-weight-bold" data-dismiss="modal">Close</button>
                                                                                    <!--<button type="submit" class="default-btn" name="register" id="submit">Update<i class="flaticon-list-1"></i></button>-->
                                                                                </div>
                                                                            </div>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">Mode of Transport </label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['mode_transport']; ?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">Lorry No </label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['lorry_no']; ?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">Train Type </label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['train_type']; ?>
                                                            </div><br><br>

                                                            <label class="col-lg-6 col-sm-12">RR No </label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['RR_No']; ?>
                                                            </div><br><br>

                                                            <label class="col-lg-6 col-sm-12">Train No </label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                                <?php echo $row['train_No']; ?>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-lg-6 col-sm-12">Flight No </label>
                                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                ...
                                                <div class="card card-custom gutter-b  example-compact">
                                                    <div class="card-header">
                                                        <h3 class="card-title" style="color: #1BC5BD;"><b>Booking</b></h3>
                                                              ...
                                                              <?php
                                                                if($row['ending_date'] > date('Y-m-d h:i:s'))
                                                                {
                                                                ?>
  ...
  <?php 
    ...
    <script>
        var button_beg = '<button id="button" onclick="showhide()">',
            button_end = '</button>';
        var show_button = '<i class="fa fa-eye" aria-hidden="true"></i>',
            hide_button = '<i class="fa fa-eye-slash" aria-hidden="true"></i>';
