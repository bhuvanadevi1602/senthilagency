                ...
                <div class="card card-custom">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#unpaid">To Pay</a>
                            </li>
                        </ul>
                                    ...
                                    ?>
                                            <div class="table-responsive">
                                                <table class="table table-separate table-head-custom table-checkable" id="kt_datatable9">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        echo $sql8 = "SELECT * FROM base where createddate >='$fromdate4' AND createddate <='$todate4' AND customer_type !='party' AND consignment_type !='month' AND 'paid' || balance !='0' order by id desc";
                ...
                ?>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="unpaid" class="container tab-pane active"><br>
                            ...
                            ?>
                                <div class="table-responsive">
                                    <table class="table table-separate table-head-custom table-checkable" id="example44">
                                        <thead>
                                            <tr>
                                                <th>S.No</th>
                                                <th>Name</th>
    ...
    <script>
        $(document).ready(function() {
            $('#example4').DataTable({
                ...
                "responsive": true,
                "ajax": {
                    "url": "ajax_request.php?action=fetch_branch_detail4",
                    "type": "POST"
                },
                "columns": [{
                        "data": "si_no"
