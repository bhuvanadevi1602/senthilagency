                        ...
                        ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-separate table-head-custom table-checkable" id="example7">
                                    ...
                                    <tbody>
                                        ...
                                        $sql5 = "SELECT * FROM booking_from where from_name='$from_name' AND status1=1 AND bill_id='$bill_id' ";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $delivery["amount"] ?></td>
                                            </tr>
                                        <?php
                                        }
                                        ?>
                            ...
                            <div class="table-responsive">
                                <table style="display:none" class="table table-separate table-head-custom table-checkable" id="kt_datatable2">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql9 = "SELECT * FROM booking_from where from_name='$from_name' AND status1=1 AND bill_id='$bill_id'";
                        ...
                        ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-separate table-head-custom table-checkable" id="example7">
                                    ...
                                    <tbody>
                                        ...
                                        $sql5 = "SELECT * FROM booking_from where from_name='$from_name' AND status1=1 AND bill_id='$bill_id' && branch = '$branch' && username = '$username'";
                                        $result5 = $conn->query($sql5);
                                        $j = 1;
                                        $s = 0;
                                        $s1 = 0;
                            ...
                            <div class="table-responsive">
                                <table style="display:none" class="table table-separate table-head-custom table-checkable" id="kt_datatable2">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql9 = "SELECT * FROM booking_from where from_name='$from_name' AND status1=1 AND bill_id='$bill_id' && branch = '$branch' && username = '$username'";
                                        $result9 = $conn->query($sql9);
                                        $j = 1;
                                        $s = 0;
                                        $s1 = 0;
