...
// 	if ($conn->query($sql)) {
// 		header("Location: customer_detail.php?&msg= Deleted!");
// 	}
// }
...
if (isset($_REQUEST['del']) != "") {
	...
	$sql = "DELETE FROM customer WHERE id='$del'";
	if ($conn->query($sql)) {
	       $sqlu = "DELETE FROM user_login WHERE name='$name'";
	  if($conn->query($sqlu)){
	    $sqlau = "DELETE FROM add_user WHERE name='$name'";
	  if($conn->query($sqlau)){
	      $sql1 = "DELETE FROM booking_from WHERE consignee_name='$name'";
	    if ($conn->query($sql1)) {
	        $sql2 = "DELETE FROM party WHERE name='$name'";
          	if ($conn->query($sql2)) {
          	    $sql3 = "DELETE FROM partyexcel WHERE name='$name'";
          	    if ($conn->query($sql3)) {
	                     header("Location: customer_detail.php?&msg= Deleted!");
          	    }
	         }
...
$mobile = $_POST['mobile'];
	...
	$sqls = "SELECT * FROM customer WHERE from_cx_id = '$from_cx_id'";
	$results = $conn->query($sqls);
	if ($results->num_rows == 0) {
		$sqls1 = "SELECT * FROM add_user WHERE user_name = '$user_name'";
		$results1 = $conn->query($sqls1);
		if ($results1->num_rows == 0) {
			$sql = "insert into customer(from_cx_id,from_name,from_address,from_contact,user_id,branch,username) values('$from_cx_id','$from_name','$from_address','$from_contact','$userId','$branch','$user_name')";
			$result = mysqli_query($conn, $sql);
// 			$sql1 = "insert into add_user(name,role,user_name,password,active_mode) values('$from_name','party','$username','$userId','$passwords',1)";
// 			$result1 = mysqli_query($conn, $sql);
			$sql1 = "insert into user_login(name,email,password,mobile,active_status,from_cx_id,username,role) values('$from_name','$email','$passwords','$from_contact',1,'$from_cx_id','$user_name','party')";
			$result1 = mysqli_query($conn, $sql1);
			
				$sql2 = "insert into add_user(name,role,active_state,user_name,password,from_cx_id) values('$from_name','party',1,'$user_name','$passwords','$from_cx_id')";
			$result2 = mysqli_query($conn, $sql2);
			
				$sqlup = "update booking_from set from_cx_id='$from_cx_id' where consignee_name='$from_name'";
// 	print_($sqlup);die();
			$resultup = mysqli_query($conn, $sqlup);

// $bookcheck="select * from booking_from where consignee_name='$from_name'";
// 			$execheck=mysqli_query($conn,$bookcheck);
// 			$fetchbook=mysqli_fetch_assoc($execheck);
// 			if($fetchbook!=""){
// 			    $upcx="update booking_from set from_cx_id='$from_cx_id' where consignee_name='$from_name'";
// 			    $execx=mysqli_query($conn,$upcx);
// 			}
			
			if ($result && $result1 && $result2 && $resultup) {
				echo "<script type='text/javascript'>
							$(document).ready(function() {
							  Swal.fire({
								  text: 'Customer detail has been added successfully!',
								  icon: 'success',
...
if (isset($_POST['update_customer_address'])) {
	...
	$sql = "update customer set from_name='$from_name',password='$password',from_address='$from_address',from_contact='$from_contact',username='$user_name' where from_cx_id='$from_cx_id'";
// 	$result = mysqli_query($conn, $sql);
	if ($conn->query($sql)) {
	    $sqlb = "update base set from_name='$from_name',from_address='$from_address',from_contact='$from_contact' where from_cx_id='$from_cx_id'";
 if ($conn->query($sqlb)) {
	          $sql2 = "update party set name='$from_name',from_address='$from_address',from_contact='$from_contact' where from_cx_id='$from_cx_id'";
          	  if ($conn->query($sql2)) {
          	       $sql3 = "update partyexcel set name='$from_name',from_contact='$from_contact' where from_cx_id='$from_cx_id'";
          	       if ($conn->query($sql3)) {
	 $sqlul = "update user_login set name='$from_name',email='$email',password='$password',mobile='$from_contact',username='$user_name' where from_cx_id='$from_cx_id' and role='party'";
      	 //  	print_r($sqlul);die();
   $conn->query($sqlul);
     
     		 $sqlau = "update add_user set name='$from_name',user_name='$user_name',password='$password where from_cx_id='$from_cx_id' and role='party'";
        $conn->query($sqlau);
					...
					<div class="card-header flex-wrap border-0 pt-6 pb-0">
						...
						<div class="card-toolbar">
							...
							<div class="modal fade" id="exampleModal22" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" name="user_form">
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											<div class="modal-header">
												<h5 class="modal-title" id="exampleModalLabel">Update Party Detail</h5>
											...
											<div class="modal-body">
												<div class="card-body">
													...
													<!--<input type="text" class="form-control" name="id" id="id" value="<?php echo $row['id'] ?>" placeholder="Enter your Name" />-->
													<input type="hidden" name="id" id="allpayment_userstatus_id">

													<div class="container">
														<div class="row">
															<div class="col-12 col-md-12">
															     <!-- hh-grayBox pt45 pb20-->
											...
											<div class="modal-footer" id="modal_footer">
												...
												<button type="submit" class="btn btn-primary font-weight-bold" name="update_customer_address">Update</button>
											</div>
										</div>
									</div>
								</form>
					...
					<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title" id="exampleModalLabel">Add Customer Detail</h5>
										<button type="button" class="close" data-dismiss="modal" aria-label="Close">
											<i aria-hidden="true" class="ki ki-close"></i>
										</button>
									</div>
										...
										<div class="card-body">
											...
											<div class="form-group row">
												...
												<div class="col-lg-9 col-md-9 col-sm-12">
													<input type="text" class="form-control" name="from_cx_id" id="from_cx_id" onkeyup="idCheck(this.value)" placeholder="Enter your customer id" required />
											...
											<div class="form-group row">
												...
												<div class="col-lg-9 col-md-9 col-sm-12">
													<input type="text" class="form-control" name="from_name" id="from_name" onkeyup="nameCheck(this.value)" placeholder="Enter your Name" required />
													<span id="existName"></span>
												</div>
											</div>
												<div class="form-group row">
												<label class="col-form-label text-right col-lg-3 col-sm-12">User Name<span style="color:red">*</span></label>
												<div class="col-lg-9 col-md-9 col-sm-12">
													<input type="text" class="form-control" name="user_name" id="user_name" onkeyup="usernameCheck(this.value)" placeholder="Enter your User Name" required />
													<span id="existUser"></span>
												</div>
											</div>
												<div class="form-group row">
												<label class="col-form-label text-right col-lg-3 col-sm-12">Password<span style="color:red">*</span></label>
												<div class="col-lg-9 col-md-9 col-sm-12">
													<input type="text" class="form-control" name="passwords" id="passwords" placeholder="Enter your password" required />
											...
											<div class="form-group row">
												...
												<div class="col-lg-9 col-md-9 col-sm-12">
													<input type="text" class="form-control" name="from_address" id="from_address" placeholder="Enter your address" required />

												</div>
											</div>
											<div class="form-group row">
												<label class="col-form-label text-right col-lg-3 col-sm-12">Contact<span style="color:red">*</span></label>
												<div class="col-lg-9 col-md-9 col-sm-12">
													<input type="text" class="form-control" maxlength="10" pattern="[1-9]{1}[0-9]{9}" name="from_contact" id="from_contact" placeholder="Enter Contact No" required />
												</div>
											</div>
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-light-danger font-weight-bold" data-dismiss="modal">Close</button>
										<button type="submit" class="btn btn-primary font-weight-bold" name="add_customer">Save</button>
									</div>
								</div>
							</div>
						</form>
											...
											<tbody>
												...
												?>
													<tr>
														...
														<td><?php echo $allfilter["from_name"] ?></td>
														<td><?php echo $allfilter["from_address"] ?></td>
														<td><?php echo $allfilter["from_contact"] ?></td>
														<td>

															<a href="customer_detail.php?id=<?php echo $allfilter["id"] ?>" id="<?php echo $allfilter["id"] ?>" class="navi-link allpayment_userstatus" data-toggle="modal" data-target="#exampleModal22">
																<span class="svg-icon svg-icon-md">
															...
															<a href="customer_detail.php?del=<?php echo $allfilter["id"] ?>&name=<?php echo $allfilter["from_name"] ?>" onclick="myFunction()" class="btn btn-sm btn-clean btn-icon" title="Delete">
								...
								<div>
									<div class="table-responsive">
										<table class="table table-separate table-head-custom table-checkable" id="kt_datatable3">
											...
											<tbody>
												<?php
												$sql = "select * from customer where branch = '$branch' order by id desc";
												$result9 = $conn->query($sql);
												$j = 1;
												while ($allfilter = $result9->FETCH_ASSOC()) {
												?>
								...
								<div>
									<div class="table-responsive">
										<table class="table table-separate table-head-custom table-checkable" id="kt_datatable3">
											...
											<tbody>
												<?php
												$sql = "select * from customer where branch = '$branch' && username = '$username' order by id desc";
												$result9 = $conn->query($sql);
												$j = 1;
												while ($allfilter = $result9->FETCH_ASSOC()) {
												?>
													<tr>
														...
														<td><?php echo $allfilter["from_contact"] ?></td>
														<!--<td>-->
														<!--    <a href="customer_detail.php?del=<?php echo $allfilter["id"] ?>" onclick="myFunction()" class="btn btn-sm btn-clean btn-icon" title="Delete">-->
														<!--        <i class="la la-trash"></i>-->
														<!--    </a>-->
														<!--</td>-->
...
<div id="kt_quick_user" class="offcanvas offcanvas-left p-10">
	...
	<div class="offcanvas-content pr-5 mr-n5">
		...
		<div>
			...
			<!--        <span class="svg-icon svg-icon-lg">-->
			<!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Write.svg--><svg <!-- xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" -->
				<!--                height="24px" viewBox="0 0 24 24" version="1.1">-->
				<!--                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">-->
				<!--                    <rect x="0" y="0" width="24" height="24" />-->
				<!--                    <path-->
				...
				<!--        <span class="svg-icon svg-icon-lg">-->
				<!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Group-chat.svg--><svg <!-- xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" -->
					<!--                height="24px" viewBox="0 0 24 24" version="1.1">-->
					<!--                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">-->
					<!--                    <rect x="0" y="0" width="24" height="24" />-->
					<!--                    <path-->
					...
					<!--        <span class="svg-icon svg-icon-lg">-->
					<!--begin::Svg Icon | path:assets/media/svg/icons/General/Attachment2.svg--><svg <!-- xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" -->
						<!--                height="24px" viewBox="0 0 24 24" version="1.1">-->
						<!--                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">-->
						<!--                    <rect x="0" y="0" width="24" height="24" />-->
						<!--                    <path-->
		...
		$.ajax({
			...
			success: function(data) {
				if (data == 'true') {
					...
					$("#existId").html("Customer Id Already Exists!");
					// document.getElementById('existId').innerHTML = 'Customer Id Already Exists!'
					document.getElementById('existId').style.color = 'red'
				} else {
					$("#existId").html("Customer Id Available!");
					// document.getElementById('existId').innerHTML = 'Customer Id Available!'
					document.getElementById('existId').style.color = 'green'
				}
			}
		});
	};
			...
			success: function(result) {
				if (result.status == 1) {
					if (result.msg == "alreadyexist") {
						$("#existName").html("Name Already Exists");
						document.getElementById('existName').style.color = 'red'
			...
			success: function(data) {
			 //   alert(result.data)
				if (data == "true") {
				    // alert('exis')
				// 	alert("Customer Id Already Exists!")
					$("#existUser").html("Username Already Exists!");
					// document.getElementById('existId').innerHTML = 'Customer Id Already Exists!'
					document.getElementById('existUser').style.color = 'red'
				} else {
					$("#existUser").html("Username Available!");
					// document.getElementById('existId').innerHTML = 'Customer Id Available!'
					document.getElementById('existUser').style.color = 'green'
				}
			}
		});
	}
	...
	$(document).ready(function() {
		$('.allpayment_userstatus').on('click', function() {
			...
			$.ajax({
				...
				dataType: "json",
				data: {
					"action": "cxdetailstatus",
					"id": id
				},
				success: function(result_job) {
					// 	alert(result_job.data[0].id)
				// 	$('#allpaymentstatusupdate').html('<input type="hidden" name="id" value="' + result_job.data[0].id + '"> <div class="form-group row"> <label class="col-form-label text-right col-lg-6 col-sm-12">Name<span style="color:red">*</span></label><div class="col-lg-6 col-sm-12"><input type="text" class="form-control" name="from_name" value="' + result_job.data[0].from_name + '" id="from_name" placeholder="Enter Name" /></div></div><div class="form-group row"><label class="col-form-label text-right col-lg-6 col-sm-12">Address<span style="color:red">*</span></label><div class="col-lg-6 col-sm-12"><input type="text" class="form-control" name="from_address" id="from_address" value="' + result_job.data[0].from_address + '" placeholder="Enter Address" /></div></div><div class="form-group row"><label class="col-form-label text-right col-lg-6 col-sm-12">Contact<span style="color:red">*</span></label><div class="col-lg-6 col-sm-12"><input type="text" class="form-control" maxlength="10" pattern="[1-9]{1}[0-9]{9}" name="from_contact" id="from_contact" value="' + result_job.data[0].from_contact + '" placeholder="Enter New Contact" /></div></div>');
				// $('#allpaymentstatusupdate').html('<input type="hidden" name="id" value="' + result_job.data[0].id + '"><div class="row col-md-12"><div class="col-md-6">Hello</div><div class="col-md-6">Hello</div></div>');
					$('#allpaymentstatusupdate').html('<input type="hidden" name="id" value="' + result_job.data[0].id + '"> <div class="col-md-12 row"><div class="col-lg-6 col-sm-12"><input type="hidden" class="form-control" name="from_cx_id" id="from_cx_id" value="' + result_job.data[0].from_cx_id + '" placeholder="Enter customer id" /></div><div class="col-md-12 row"><div class="col-md-3 col-sm-12"><label class="col-form-label text-right">Name<span style="color:red">*</span></label></div><div class="col-md-9 col-sm-12"><input type="text" class="form-control" name="from_name" value="' + result_job.data[0].from_name + '" id="from_name" placeholder="Enter Name" /></div></div><div class="col-md-12 row mt-3"><div class="col-md-3"><label class="col-form-label text-right">Password<span style="color:red">*</span></label></div><div class="col-lg-9 col-sm-12"><input type="text" class="form-control" name="passwords" value="' + result_job.data[0].password + '" id="from_name" placeholder="Enter Password" /></div></div><div class="col-md-12 row mt-3"><div class="col-md-3"><label class="col-form-label text-right">Email<span style="color:red">*</span></label></div><div class="col-lg-9 col-sm-12"><input type="email" class="form-control" name="email" value="' + result_job.data[0].email + '" id="email" placeholder="Enter Email" /></div></div><div class="col-md-12 row mt-3"><div class="col-md-3"><label class="col-form-label text-right">Username<span style="color:red">*</span></label></div><div class="col-lg-9 col-sm-12"><input type="text" class="form-control" name="username" value="' + result_job.data[0].username + '" id="username" placeholder="Enter username" /></div></div><div class="col-md-12 mt-3 row"><div class="col-md-3"><label class="col-form-label text-right">Address<span style="color:red">*</span></label></div><div class="col-md-9 col-sm-12"><input type="text" class="form-control" name="from_address" id="from_address" value="' + result_job.data[0].from_address + '" placeholder="Enter Address" /></div></div><div class="col-md-12 row mt-3"><div class="col-md-3"><label class="col-form-label text-right">Contact<span style="color:red">*</span></label></div><div class="col-md-9 col-sm-12"><input type="text" class="form-control" name="from_contact" id="from_contact" value="' + result_job.data[0].from_contact + '" placeholder="Enter New Contact" /></div></div>');
				}
			});
		});
