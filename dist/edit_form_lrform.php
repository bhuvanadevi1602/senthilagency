...
if (isset($_POST['register'])) {
       ...
       $from_contact = $_POST["from_contact"];
              ...
              echo $update_otp = "UPDATE base SET from_name='$from_name',
    from_address='$from_address',from_contact='$from_contact'
    where id='$id'";

              $update_otp_sql = mysqli_query($conn, $update_otp); {
                    //   header("Location: view_lr_branch.php");
                        echo "<script>window.location.href='view_lr_branch.php';</script>";
