...
if (isset($_POST['register'])) {
    ...
    $total = $_POST["total"];
    $created_at = date("Y-m-d h:i:s");$count = $_POST["no_stop"];
    ...
    if ($agent_contact == '') {
        ...
        if ($sender == 'sender') {
            ...
            $stext =  rawurlencode("Dear $from_name,Your consignment bearing LR No. $lr_no is booked successfully. For more details contact us on 93825 87897.Regards,APS Cargo Movers");
        ...
        if ($receiver == 'receiver') {
            $stext =  rawurlencode("Dear $to_name, Your consignment bearing LR No. $lr_no is booked successfully. For more details contact us on 93825 87897. Regards, APS Cargo Movers");
        ...
        if ($agents == "agent_name") {
            $apiKey = urlencode('1ObuTC6o9EuZGWWeqhWAeA');
            $stext =  rawurlencode("Dear $agent_name, Your consignment bearing LR No. $lr_no is booked successfully. For more details contact us on 93825 87897. Regards, APS Cargo Movers");
    ...
    if ($from_name != "" && $consignment_type1 != "") {
        $insert1 = "INSERT into base (username,branch,user_id,createdAt,customer_type,booking_type,lr_no,consignment_type,invoice_type,
                        material_name,quantity_kg,quantity_nos,rate,docket_charge,gst,gstamount,agent_commission,
                        to_name,to_address,to_contact,from_active,from_cx_id,from_name,
                        ...
                        repayment_date,repayment,createddate,ending_date,month_name
                        ) 
                    values('$username','$branch','$userId','$createdAt','$customer_type','$booking_type','$lr_no','$consignment_type1','$invoice_type',
                    '$material_name','$quantity_kg','$quantity_nos','$rate','$docket_charge','$gst','$gstamount','$agent_commission'
                    ,'$to_name','$to_address','$to_contact','$from_active','$from_cx_id','$from_name',
                    '$from_address','$from_contact',
                    '$company_name','$invoice_no','$vehicle_halting','$unloading_charge',
                    '$gstamount_value','$total','$subtotal','$total',0,'$total','$bill_amount',
                    '$repay_date','$repayment','$createdAt','$end_time','$month_name'
                    ) ";
        ...
        $insert1 = "INSERT into base (username,branch,user_id,createdAt,customer_type,booking_type,lr_no,consignment_type,invoice_type,
                    ...
                    values('$username','$branch','$userId','$createdAt','$customer_type','$booking_type','$lr_no','$consignment_type','$invoice_type',
                    '$material_name','$quantity_kg','$quantity_nos','$rate','$docket_charge','$gst','$gstamount','$agent_commission'
                    ,'$to_name','$to_address','$to_contact','$from_active','$from_cx_id','$from_name1',
                    '$from_address1','$from_contact1',
                    '$company_name','$invoice_no','$vehicle_halting','$unloading_charge',
                    '$gstamount_value','$total','$subtotal','$total',0,'$total','$bill_amount',
                    '$repay_date','$repayment','$createdAt','$end_time','$month_name'
                    ) ";
    ...
    if (mysqli_query($conn, $insert1)) {
        ...
        if ($consignment_type == "paid") {
            ...
            if ($conn->query($sql2)) {
                ...
                $sql2 = "INSERT into transaction_history (branch_name,user_id,username,from_name,category,amount,credit,debit,balance,lr_no,branch_id,customer) 
		values('$branch','$userId','$username','$from_name1','$consignment_type','$total','$total',0,'$branch_balance1','$lr_no','$branch_id','$from_name')";
                // 		exit();
                if ($conn->query($sql2)) {
                            ...
                            <div class="card card-custom example-compact">
                                ...
                                <div class="card-body" id="optClass49">
                                    ...
                                    <div class="form-group row" style="display:none">
                                     ...
                                     <div class="form-group row" style="display:none">
                                                    <label class="col-form-label text-right col-lg-3 col-sm-12">Active<span style="color:red">*</span></label>
                                                    <div class="col-lg-9 col-md-9 col-sm-12" id="from_acts2">
                                                        <input type="text" class="form-control" name="from_active" id="from_active" id="from_active" placeholder="Enter your id" />
                                                        <span class="form-text text-muted">We'll never share your name No with anyone else.</span>
                                                    </div>
                                                </div>
...
<script>
    ...
    // 						// $('#from_detail1').html('<select class="form-control" name="mode_transport" id="mode_transport" required><option selected disabled>Select</option><option value="road">Road</option><option value="train">Train</option><option value="air">Air</option></select>                                                         </form>');
