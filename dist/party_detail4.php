                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-separate table-head-custom table-checkable" id="example3">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $sql5 = "SELECT * FROM base where customer_type='party' && from_cx_id='$from_cx_id' && status1=1";
                                                        $result5 = $conn->query($sql5);
                                                        $j = 1;
                                                        while ($delivery = $result5->FETCH_ASSOC()) {
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <?php
                        if($delivery["gstamount"]  != '')
                        { ?>
                        <td><?php echo $delivery["gstamount"] ?></td>
                        <?php 
                        }else{
                        ?>
                         <td>0</td>
                                        ...
                                        ?>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-separate table-head-custom table-checkable" id="example3">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $sql5 = "SELECT * FROM base where customer_type='party' && from_cx_id='$from_cx_id' && createddate >='$fromdate1' && createddate <='$todate1'  && status1=1";
                                                            $result5 = $conn->query($sql5);
                                                            $j = 1;
                                                            while ($delivery = $result5->FETCH_ASSOC()) {
...
<script>
    function fnExcelReport3() {
        var tab_text = "<table border='2px'><tr class='col-sm-12 d-flex justify-content-center text-center'><th colspan='17'><h1>&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;APS CARGOS MOVERS&ensp;&ensp;&ensp;</h1></th></tr><tr class='col-sm-12 d-flex justify-content-center text-center'><th colspan='17'><h4>102,WALL TEX ROAD,CHENNAI 600003</h4></th></tr><tr class='col-sm-12 d-flex justify-content-center text-center'><th colspan='17'><h2>TEL NO:- 044-42012933,MOB NO:-9382587896,E-Mail:-apscargo102@gmail.com</h2></th></tr><tr style='bgcolor='#fff82a'>";
        var textRange;
