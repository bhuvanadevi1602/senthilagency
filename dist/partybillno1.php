						...
						?>
							...
							<div class="table-responsive">
								<table class="table table-separate table-head-custom table-checkable" id="example7">
									...
									<tbody>
										...
										$sql5 = "SELECT * FROM base where from_name='$from_name' AND status1=1 AND bill_id='$bill_id' ";
										...
										while ($delivery = $result5->FETCH_ASSOC()) {
											...
											$sql55 = "SELECT * FROM party where bill_id='$bill_id'";
											$result55 = $conn->query($sql55);
											$delivery11 = $result55->FETCH_ASSOC();
											$s2 =  $delivery11["balance"];
										?>
											<tr>
												<td><?php echo $delivery["lr_no"] ?></td>
												<td><?php echo $delivery["from_name"] ?></td>
												<td><?php echo $delivery["to_address"] ?></td>
												<td><?php echo $delivery["total"] ?></td>
												<!--<td><?php echo $delivery["amount_paid1"] ?></td>-->
							...
							<div class="table-responsive">
								<table style="display:none" class="table table-separate table-head-custom table-checkable" id="kt_datatable2">
									...
									<tbody>
										<?php
										$sql9 = "SELECT * FROM base where from_name='$from_name' AND status1=1 AND bill_id='$bill_id'";
										...
										while ($allfilter = $result9->FETCH_ASSOC()) {
											...
											$string1 =  (int) $allfilter["amount_paid1"];
											$s1 = $s1 + $string1;
										...
										?>
											<tr>
												...
												<!--<td><?php echo $allfilter["amount_paid1"] ?></td>-->
										...
										<tr>
											...
											<td></td>
											<td>
												<b>Total:</b><?php echo $s ?>
											</td>
											<td>
												<b>Amount Paid:</b><?php echo $s1 ?>
											</td>
											<td>
												<b>Balance:</b><?php echo $s2 ?>
											</td>
										</tr>
									</tbody>
								</table>
						...
						?>
							...
							<div class="table-responsive">
								<table class="table table-separate table-head-custom table-checkable" id="example7">
									...
									<tbody>
										...
										$sql5 = "SELECT * FROM base where from_name='$from_name' AND status1=1 AND bill_id='$bill_id' && branch = '$branch'";
										$result5 = $conn->query($sql5);
										$j = 1;
										$s = 0;
										$s1 = 0;
										...
										while ($delivery = $result5->FETCH_ASSOC()) {
											...
											$sql55 = "SELECT * FROM party where bill_id='$bill_id' && branch1 = '$branch' && username1 = '$username' ";
											$result55 = $conn->query($sql55);
											$delivery11 = $result55->FETCH_ASSOC();
											$s2 =  $delivery11["balance"];
										?>
							...
							<div class="table-responsive">
								<table style="display:none" class="table table-separate table-head-custom table-checkable" id="kt_datatable2">
									...
									<tbody>
										<?php
										$sql9 = "SELECT * FROM base where from_name='$from_name' AND status1=1 AND bill_id='$bill_id' && branch = '$branch' ";
										$result9 = $conn->query($sql9);
										$j = 1;
										$s = 0;
										$s1 = 0;
						...
						?>
							...
							<div class="table-responsive">
								<table class="table table-separate table-head-custom table-checkable" id="example7">
									...
									<tbody>
										...
										$sql5 = "SELECT * FROM base where from_name='$from_name' AND status1=1 AND bill_id='$bill_id' && branch = '$branch' && username = '$username'";
										$result5 = $conn->query($sql5);
										$j = 1;
										$s = 0;
										$s1 = 0;
							...
							<div class="table-responsive">
								<table style="display:none" class="table table-separate table-head-custom table-checkable" id="kt_datatable2">
									...
									<tbody>
										<?php
										$sql9 = "SELECT * FROM base where from_name='$from_name' AND status1=1 AND bill_id='$bill_id' && branch = '$branch' && username = '$username'";
										$result9 = $conn->query($sql9);
										$j = 1;
										$s = 0;
										$s1 = 0;
