...
if (isset($_REQUEST['del']) != "") {
	$del = $_REQUEST['del'];
		$name = $_REQUEST['name'];
	$sql = "DELETE FROM company WHERE id='$del'";
	if ($conn->query($sql)) {
	
		$sqlu = "DELETE FROM user_login WHERE from_cx_id='$del' and role='company'";
$conn->query($sqlu);


		$sqau = "DELETE FROM add_user WHERE from_cx_id='$del' and role='company'";
$conn->query($sqau);
...
if (isset($_POST['add_company'])) {
	...
	$sql = "insert into company(company_name,address,gst,branch,username,user_name,email,mobile) values('$company_name','$address','$gst','$branch','$username','$user_name','$email','$mobile')";
	$result = mysqli_query($conn, $sql);

$last_id = mysqli_insert_id($conn);

	$sql2 = "insert into add_user(name,role,active_state,password,from_cx_id,user_name) values('$company_name','company',1,'$password',$last_id,'$user_name')";
			$result2 = mysqli_query($conn, $sql2);
		
	$sql3 = "insert into user_login(name,email,password,mobile,active_status,from_cx_id,username,role) values('$company_name','$email','$password','$mobile',1,$last_id,'$user_name','company')";
			$result3 = mysqli_query($conn, $sql3);
			
					$upbook="update base set from_cx_id='$last_id' where consignee_name='$company_name'";
			$result2book = mysqli_query($conn, $upbook);
			
					
	$sqlup = "update booking_from set from_cx_id='$last_id' where consignee_name='$company_name'";
// 	print_($sqlup);die();
			$resultup = mysqli_query($conn, $sqlup);
		
	if ($result && $result2 && $result3 && $resultup) {
		echo "<script type='text/javascript'>

                     $(document).ready(function() {
                      Swal.fire({
                  
                  text: 'Company Created Success!',
                  icon: 'success',
...
if (isset($_POST['update_company'])) {
  $id=$_REQUEST['editsid'];
    $companyname=$_REQUEST['ed_companyname'];
    $addrss=$_REQUEST['ed_address'];
    $gst=$_REQUEST['ed_gst'];
    $mobile=$_REQUEST['ed_mobile'];
    $email=$_REQUEST['ed_email'];
    $username=$_REQUEST['ed_username'];
    $pasword=$_REQUEST['ed_password'];
   	  $role=$_REQUEST['ed_role'];
  
  
  	 $sql="update company set company_name='$companyname',address='$addrss',gst='$gst',mobile='$mobile',email='$email',username='$username' where id=$id ";
$result=mysqli_query($conn,$sql);

		$sql1="update add_user set name='$companyname',user_name='$username',password='$pasword' where from_cx_id=$id and role='company'";
    //  print_r($sql);die();		
$result1=mysqli_query($conn,$sql1);

		$sql2="update user_login set name='$companyname',email='$email',username='$username',password='$pasword',mobile='$mobile' where from_cx_id=$id and role='company'";
    //  print_r($sql);die();		
$result2=mysqli_query($conn,$sql2);
	...
	<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
		...
		<div class="subheader py-3 py-lg-8  subheader-transparent " id="kt_subheader">
			<div class=" container  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
				...
				<!--begin::Button-->
				<a href="#" class="" data-toggle="modal" data-target="#kt_chat_modal">
					<span class="">
				...
				<div class="card card-custom">
					<div class="card-header flex-wrap border-0 pt-6 pb-0">
						...
						<div class="card-toolbar">
							...
							<a href="#" class="btn btn-primary font-weight-bolder" data-toggle="modal" data-target="#create_user_modal">
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												<div class="card-body">
													...
													<input type="hidden" class="form-control" name="edit_id" id="edit_id" placeholder="Enter your Name" />
													<div class="form-group row">
														<label class="col-form-label text-right col-lg-3 col-sm-12">Company Name<span style="color:red">*</span></label>
														<div class="col-lg-9 col-md-9 col-sm-12">
															...
															<!--    Company Name with anyone else.</span>-->
														</div>
													</div>
													<div class="form-group row">
													...
													<div class="form-group row">
														...
														<div class="form-group row">
														<label class="col-form-label text-right col-lg-3 col-sm-12">Mobile <span style="color:red">*</span></label>
														<div class="col-lg-9 col-md-9 col-sm-12">
														...
														<div class="form-group row">
														<label class="col-form-label text-right col-lg-3 col-sm-12">Username<span style="color:red">*</span></label>
														<div class="col-lg-9 col-md-9 col-sm-12">
													...
													<!--<div class="form-group row">-->
													<!--    <label-->
													<!--        class="col-form-label text-right col-lg-3 col-sm-12">ITC Limited<span-->
													<!--            style="color:red">*</span></label>-->
													<!--    <div class="col-lg-9 col-md-9 col-sm-12">-->
													<!--        <input type="text" class="form-control" name="itc"-->
													<!--            id="itc" placeholder="ITC Limited" required />-->
													<!--<span class="form-text text-muted">We'll never share your-->
													<!--    ITC with anyone else.</span>-->
													<!--    </div>-->
													<!--</div>-->
													<!--<div class="form-group row">-->
													<!--    <label-->
													<!--        class="col-form-label text-right col-lg-3 col-sm-12">Ideal<span-->
													<!--            style="color:red">*</span></label>-->
													<!--    <div class="col-lg-9 col-md-9 col-sm-12">-->
													<!--        <input type="text" class="form-control" name="ideal"-->
													<!--            id="ideal" placeholder="Ideal" required />-->
													<!--<span class="form-text text-muted">We'll never share your-->
													<!--    Ideal with anyone else.</span>-->
													<!--    </div>-->
													<!--</div>-->

													<!--<div class="form-group row">-->
													<!--    <label-->
													<!--        class="col-form-label text-right col-lg-3 col-sm-12">EFF<span-->
													<!--            style="color:red">*</span></label>-->
													<!--    <div class="col-lg-9 col-md-9 col-sm-12">-->
													<!--        <input type="text" class="form-control" name="ff"-->
													<!--            id="ff" placeholder="EFF" required />-->
													<!--<span class="form-text text-muted">We'll never share your-->
													...
													<!--<div class="form-group row">-->
													<!--    <label-->
													<!--        class="col-form-label text-right col-lg-3 col-sm-12">K-Link<span-->
													<!--            style="color:red">*</span></label>-->
													<!--    <div class="col-lg-9 col-md-9 col-sm-12">-->
													<!--        <input type="text" class="form-control" name="link"-->
													<!--            id="link" placeholder="K-link" required />-->
													<!--<span class="form-text text-muted">We'll never share your-->
													<!--    K-Link with anyone else.</span>-->
													<!--    </div>-->
													<!--</div>-->

													<!--<div class="form-group row">-->
													<!--    <label-->
													<!--        class="col-form-label text-right col-lg-3 col-sm-12">Manna Food<span-->
													<!--            style="color:red">*</span></label>-->
													<!--    <div class="col-lg-9 col-md-9 col-sm-12">-->
													<!--        <input type="text" class="form-control" name="mark"-->
													<!--            id="mark" placeholder="Enter your Name" required />-->
													<!--<span class="form-text text-muted">We'll never share your-->
													<!--    Manna Food with anyone else.</span>-->
													<!--    </div>-->
													<!--</div>-->
											...
											<div class="modal-footer" id="modal_footer">
												...
												<button type="submit" class="btn btn-primary font-weight-bold" name="add_company">Save
												</button>
											</div>
										</div>
									</div>
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												<div class="card-body">
													...
													<input type="hidden" class="form-control" name="editsid" id="editsid" placeholder="Enter your id" />
													<input type="hidden" class="form-control" name="ed_role" id="ed_role" placeholder="Enter your role" />
													<div class="form-group row">
														<label class="col-form-label text-right col-lg-3 col-sm-12">Company Name<span style="color:red">*</span></label>
														<div class="col-lg-9 col-md-9 col-sm-12">
															<input type="text" class="form-control" name="ed_companyname" id="ed_companyname" placeholder="Enter Company Name" required />
															<!--<span class="form-text text-muted">We'll never share your-->
															<!--    Company Name with anyone else.</span>-->
														</div>
													</div>
													<div class="form-group row">
														<label class="col-form-label text-right col-lg-3 col-sm-12">Address<span style="color:red">*</span></label>
														<div class="col-lg-9 col-md-9 col-sm-12">
															<input type="text" class="form-control" name="ed_address" id="ed_address" placeholder="Enter Address" required />
															<!--<span class="form-text text-muted">We'll never share your-->
															<!--    Company Name with anyone else.</span>-->
														</div>
													</div>
													<div class="form-group row">
														<label class="col-form-label text-right col-lg-3 col-sm-12">GST<span style="color:red">*</span></label>
														<div class="col-lg-9 col-md-9 col-sm-12">
															<input type="text" class="form-control" name="ed_gst" id="ed_gst" placeholder="Enter gst" required />
															<!--<span class="form-text text-muted">We'll never share your-->
															<!--    Company Name with anyone else.</span>-->
														</div>
													</div>
														...
														<div class="col-lg-9 col-md-9 col-sm-12">
															<input type="text" class="form-control" name="ed_mobile" id="ed_mobile" placeholder="Enter Mobile" required />
															<!--<span class="form-text text-muted">We'll never share your-->
															<!--    Company Name with anyone else.</span>-->
														</div>
													</div>
														...
														<div class="col-lg-9 col-md-9 col-sm-12">
															<input type="text" class="form-control" name="ed_username" id="ed_username" placeholder="Enter Username" required />
															<!--<span class="form-text text-muted">We'll never share your-->
															<!--    Company Name with anyone else.</span>-->
														</div>
													</div>
													<div class="form-group row">
														<label class="col-form-label text-right col-lg-3 col-sm-12">Email</label>
														<div class="col-lg-9 col-md-9 col-sm-12">
															<input type="email" class="form-control" name="ed_email" id="ed_email" placeholder="Enter Email" />
															<!--<span class="form-text text-muted">We'll never share your-->
															<!--    Company Name with anyone else.</span>-->
														</div>
													</div>
														...
														<div class="col-lg-9 col-md-9 col-sm-12">
															<input type="text" class="form-control" name="ed_password" id="ed_password" placeholder="Enter Password" required />
															<!--<span class="form-text text-muted">We'll never share your-->
															<!--    Company Name with anyone else.</span>-->
														</div>
													</div>
											...
											<div class="modal-footer" id="modal_footer">
												<button type="button" class="btn btn-light-danger font-weight-bold" data-dismiss="modal">Close</button>
												<input type="submit" class="btn btn-primary font-weight-bold" name="update_company" value="Update" />
												</button>
											</div>
										</div>
									</div>
						...
						?>
							...
							<table class="table table-separate table-head-custom table-checkable" id="example3">
								...
								?>
									<tr>
										<td><?php echo $j++ ?></td>
										<td><?php echo $allfilter["company_name"] ?></a></td>
										<td><?php echo $allfilter["address"] ?></td>
										<td><?php echo $allfilter["gst"] ?></td>
										<td><?php echo $allfilter["username"] ?></td>
										<?php
										$cxid=$allfilter["id"];
											$sqlp = "select * from user_login where from_cx_id='$cxid' and role='company'";
							$resultp = $conn->query($sqlp);
							$fetchpass= $resultp -> fetch_assoc();
										?>
										<td><?php echo $fetchpass["password"] ?></td>
									<td>
										    
							<a href="#" class=" font-weight-bolder editcompany" id="editcompany" data-toggle="modal" data-target="#edit_user_modal" ids="<?=$allfilter["id"]?>">
							<i class="la la-pen"></i>
						</a>
	<a href="company.php?del=<?php echo $allfilter["id"] ?>&name=<?=$allfilter["company_name"] ?>" onclick="myFunction()" class="btn btn-sm btn-clean btn-icon" title="Delete">
						...
						?>
							...
							<table class="table table-separate table-head-custom table-checkable" id="example3">
								...
								<?php
								$sql = "select * from company where branch = '$branch' order by id desc";
								$result9 = $conn->query($sql);
								$j = 1;
								while ($allfilter = $result9->FETCH_ASSOC()) {
								?>
									<tr>
										...
										<td><?php echo $allfilter["gst"] ?></td>
										<td>
											<a href="company.php?del=<?php echo $allfilter["id"] ?>" onclick="myFunction()" class="btn btn-sm btn-clean btn-icon" title="Delete">
												<i class="la la-trash"></i>
											</a>
										</td>
									</tr>
						...
						?>
							...
							<table class="table table-separate table-head-custom table-checkable" id="example3">
								...
								<?php
								$sql = "select * from company where branch = '$branch' && username = '$username' order by id desc";
								$result9 = $conn->query($sql);
								$j = 1;
								while ($allfilter = $result9->FETCH_ASSOC()) {
								?>
...
<div id="kt_quick_user" class="offcanvas offcanvas-left p-10">
	...
	<div class="offcanvas-content pr-5 mr-n5">
		...
		<div>
			...
			<!--begin::Svg Icon | path:assets/media/svg/icons/Home/Library.svg--><svg <!-- xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" -->
...
<script>
	$(document).ready(function() {
		$('#company_table').DataTable({
			...
			"responsive": true,
			"ajax": {
				"url": "ajax_request.php?action=fetch_company_detail",
				"type": "POST"
			},
			"columns": [{
					"data": "id"
			...
			columnDefs: [{
				...
				// },
				{
					target: 4,
					render: function(data, type, row) {
						return '<a href="#" id="' + row.id + '" class="btn btn-sm btn-clean btn-icon delete_company" title="Delete"><span class="svg-icon svg-icon-md"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"/><path d="M6,8 L6,20.5 C6,21.3284271 6.67157288,22 7.5,22 L16.5,22 C17.3284271,22 18,21.3284271 18,20.5 L18,8 L6,8 Z" fill="#000000" fill-rule="nonzero"/><path d="M14,4.5 L14,4 C14,3.44771525 13.5522847,3 13,3 L11,3 C10.4477153,3 10,3.44771525 10,4 L10,4.5 L5.5,4.5 C5.22385763,4.5 5,4.72385763 5,5 L5,5.5 C5,5.77614237 5.22385763,6 5.5,6 L18.5,6 C18.7761424,6 19,5.77614237 19,5.5 L19,5 C19,4.72385763 18.7761424,4.5 18.5,4.5 L14,4.5 Z" fill="#000000" opacity="0.3"/></g></svg></span></a><div class="dropdown dropdown-inline"></div>';
						//   return '<a href="#" id="'+row.id+'" class="btn btn-sm btn-clean btn-icon mr-2 edit_company" title="Edit details"><span class="svg-icon svg-icon-md"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"/><path d="M8,17.9148182 L8,5.96685884 C8,5.56391781 8.16211443,5.17792052 8.44982609,4.89581508 L10.965708,2.42895648 C11.5426798,1.86322723 12.4640974,1.85620921 13.0496196,2.41308426 L15.5337377,4.77566479 C15.8314604,5.0588212 16,5.45170806 16,5.86258077 L16,17.9148182 C16,18.7432453 15.3284271,19.4148182 14.5,19.4148182 L9.5,19.4148182 C8.67157288,19.4148182 8,18.7432453 8,17.9148182 Z" fill="#000000" fill-rule="nonzero"\ transform="translate(12.000000, 10.707409) rotate(-135.000000) translate(-12.000000, -10.707409) "/><rect fill="#000000" opacity="0.3" x="5" y="20" width="15" height="2" rx="1"/></g></svg></span></a><a href="#" id="'+row.id+'" class="btn btn-sm btn-clean btn-icon delete_company" title="Delete"><span class="svg-icon svg-icon-md"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"/><path d="M6,8 L6,20.5 C6,21.3284271 6.67157288,22 7.5,22 L16.5,22 C17.3284271,22 18,21.3284271 18,20.5 L18,8 L6,8 Z" fill="#000000" fill-rule="nonzero"/><path d="M14,4.5 L14,4 C14,3.44771525 13.5522847,3 13,3 L11,3 C10.4477153,3 10,3.44771525 10,4 L10,4.5 L5.5,4.5 C5.22385763,4.5 5,4.72385763 5,5 L5,5.5 C5,5.77614237 5.22385763,6 5.5,6 L18.5,6 C18.7761424,6 19,5.77614237 19,5.5 L19,5 C19,4.72385763 18.7761424,4.5 18.5,4.5 L14,4.5 Z" fill="#000000" opacity="0.3"/></g></svg></span></a><div class="dropdown dropdown-inline"></div>';
					}
				},
			]
		});

// 		$('#company_table').on('click', '.edit_company', function() {
...
// 					$('#edit_id').val(result_job.data[0].id);
// 					$('#company_name').val(result_job.data[0].company_name);

// 					$('#itc').val(result_job.data[0].itc);
// 					$('#ideal').val(result_job.data[0].ideal);
// 					$('#ff').val(result_job.data[0].ff);
// 					$('#link').val(result_job.data[0].link);
// 					$('#mark').val(result_job.data[0].mark);
// 					$('#modal_footer').html('<button type="button" class="btn btn-light-danger font-weight-bold"data-dismiss="modal">Close</button><button type="submit" class="btn btn-primary font-weight-bold" name="update_company">Update</button>');
// 				}
// 			});
// 		});
...
$("#editsid").val(id);
	$.ajax({
				...
				success: function(result_job) {
					$('#ed_companyname').val(result_job.data[0].company_name);
					$('#ed_role').val(result_job.data[0].role);
	$('#ed_address').val(result_job.data[0].address);
					$('#ed_gst').val(result_job.data[0].gst);
					$('#ed_username').val(result_job.data[0].username);
					$('#ed_email').val(result_job.data[0].email);
					$('#ed_mobile').val(result_job.data[0].mobile);
						$('#ed_password').val(result_job.data[0].password);
				// $('#modal_footer').html('<button type="button" class="btn btn-light-danger font-weight-bold"data-dismiss="modal">Close</button>');
				}
			});
		});
...
<script>
	function check() {
		...
		var branch = document.forms['user_form']['branch'].value;

		if (branch == "") {
			document.getElementById('error_element2').innerHTML = "Branch required";
			return false;
		} else {
