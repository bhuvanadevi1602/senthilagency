...
// $exp_qry = "SELECT id FROM base ORDER BY id DESC LIMIT 1 ";
// $exp_sql = $conne->prepare("$exp_qry");
// $exp_sql->execute();

// $exp_row = $exp_sql->fetch(PDO::FETCH_ASSOC);
// $id = $exp_row["id"];

echo $sql = "SELECT * FROM base WHERE id='$id'";
...
if (isset($_POST['register'])) {
       ...
       $delivery_message = $_POST["delivery_message"];
              ...
              echo $update_otp = "UPDATE base SET booking_type='$booking_type',lr_no='$lr_no',railway_no='$railway_no',consignment_type='$consignment_type',
    invoice_type='$invoice_type',mode_transport='$mode_transport',lorry_no='$lorry_no',train_type='$train_type',
    RR_No='$RR_No',train_No='$train_No',flight_no='$flight_no',internal_info='$internal_info',eway_bill='$eway_bill',
    destination='$destination',
    material_name='$material_name',quantity_kg='$quantity_kg',quantity_nos='$quantity_nos',rate='$rate',
    docket_charge='$docket_charge',cd_charge='$cd_charge',gst='$gst',cgst='$cgst',sgst='$sgst',igst='$igst',agent_commission='$agent_commission',
    to_name='$to_name',to_address='$to_address',to_contact='$to_contact',from_name='$from_name',
    from_address='$from_address',from_contact='$from_contact',agent='$agent',agent_name='$agent_name', agent_city='$agent_city',delivery_message='$delivery_message'
    where id='$id'";

              $update_otp_sql = mysqli_query($conn, $update_otp); {
                      header("Location: view_lr_branch.php");
              }
}
                            ...
                            <div class="d-flex align-items-center flex-wrap mr-1">
                                   ...
                                   <div class="d-flex align-items-baseline flex-wrap mr-5">
                                          ...
                                          <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
                                                 ...
                                                 <li class="breadcrumb-item">
                                                        <a href="" class="text-muted">Basic Validation
                                                               Form Validation </a>
                                                 </li>
                                                 <li class="breadcrumb-item">
                                                        <a href="" class="text-muted">
                                                               ...
                                                               <div class="card card-custom example example-compact">
                                                                      ...
                                                                      <div class="card-body">
                                                                             ...
                                                                             <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <select class="form-control" name="booking_type" id="booking_type" required>
                                                                                                  ...
                                                                                                  <option value="lease" <?php echo $lease; ?>>Lease</option>
                                                                                           </select>
                                                                             ...
                                                                             <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <input type="text" class="form-control" name="lr_no" id="lr_no" value="<?php echo $row['lr_no']; ?>" placeholder="Enter your LR No" required />
                                                                             ...
                                                                             <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <input type="text" class="form-control" name="railway_no" id="railway_no" value="<?php echo $row['railway_no'] ?>" placeholder="Enter your Railway No" />
                                                                             ...
                                                                             <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <select class="form-control" name="consignment_type" id="consignment_type" required>
                                                                                                  ...
                                                                                                  <?php
                                                                                                  $tbb = $to_pay  = $month = $paid = "";
                                                                                                  switch ($row['consignment_type']) {
                                                                                                         case 'tbb':
                                                                                                                $tbb = 'selected';
                                                                                                                break;
                                                                                                         case 'to_pay':
                                                                                                  ...
                                                                                                  ?>
                                                                                                  <option value="tbb" <?php echo $tbb; ?>>Tbb</option>
                                                                                                  <option value="to_pay" <?php echo $to_pay; ?>>To Pay</option>
                                                                             ...
                                                                             <div class="form-group row" onchange="status11(this)">
                                                                                    ...
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <select class="form-control" name="invoice_type" id="invoice_type" required>
                                                                                                  ...
                                                                                                  ?>
                                                                                                  <option value="binvoice" <?php echo $binvoice; ?>>B - Invoice</option>
                                                                                                  <option value="vestimate" <?php echo $vestimate; ?>>V - Estimate</option>
                                                                                           </select>
                                                                                    </div>
                                                                             </div>
                                                                             <div class="form-group row" onchange="status2(this);">
                                                                                    ...
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <select class="form-control" name="mode_transport" id="mode_transport" required>
                                                                                                  ...
                                                                                                  ?>
                                                                                                  <option value="road" <?php echo $road; ?>>Road</option>
                                                                                                  <option value="train" <?php echo $train; ?>>Train</option>
                                                                                                  <option value="air" <?php echo $air; ?>>Air</option>
                                                                                           </select>
                                                                                    </div>
                                                                             </div>
                                                                             <div class="form-group row" id="productoptClass" style="display:none;">
                                                                                    ...
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <input type="text" class="form-control" name="lorry_no" id="lorry_no" value="<?php echo $row['lorry_no']; ?>" placeholder="Enter your Lorry No" />
                                                                                           <span class="form-text text-muted">We'll never share your email with anyone else.</span>
                                                                                    </div>
                                                                             </div>
                                                                             <div class="form-group row" id="productoptClass1" style="display:none;">
                                                                                    ...
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <select class="form-control" name="train_type" id="train_type">
                                                                                                  ...
                                                                                                  ?>
                                                                                                  <option value="rear" <?php echo $rear; ?>>Rear</option>
                                                                                                  <option value="front" <?php echo $front; ?>>Front</option>
                                                                                           </select>
                                                                                    </div>

                                                                                    <label class="col-form-label text-right col-lg-3 col-sm-12">RR No </label>
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <input type="text" class="form-control" name="RR_No" id="RR_No" value="<?php echo $row['RR_No'] ?>" placeholder="Enter your Lorry No" />
                                                                                    </div>

                                                                                    <label class="col-form-label text-right col-lg-3 col-sm-12">Train No </label>
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <input type="text" class="form-control" name="train_No" id="train_No" placeholder="Enter your Train No" value="<?php echo $row['train_No'] ?>"/>
                                                                                    </div>
                                                                             </div>
                                                                             ...
                                                                             <div class="form-group row" id="productoptClass2" style="display:none;">
                                                                                    ...
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <input type="text" class="form-control" name="flight_no" id="flight_no" placeholder="Enter your Flight No" value="<?php echo $row['flight_no'] ?>"/>
                                                                                    </div>
                                                                             </div>
                                                                             <div class="form-group row">
                                                                                    <label class="col-form-label text-right col-lg-3 col-sm-12">Internal Info </label>
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <input type="text" class="form-control" name="internal_info" id="internal_info" value="<?php echo $row['internal_info'] ?>" placeholder="Enter your Internal Info" />
                                                                                    </div>
                                                                             </div>
                                                                             <div class="form-group row">
                                                                                    <label class="col-form-label text-right col-lg-3 col-sm-12">Eway Bill No </label>
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <input type="text" class="form-control" name="eway_bill" id="eway_bill" value="<?php echo $row['eway_bill'] ?>" placeholder="Enter your Eway Bill" />
                                                                                    </div>
                                                                             </div>
                                                                      ...
                                                                      <div class="card-body">
                                                                             ...
                                                                             <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <select class="form-control" aria-label="Default select example" id="no_stop" name="no_stop">
                                                                             ...
                                                                             <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <div class="input-group">
                                                                                                  ...
                                                                                                  <input type="text" class="form-control" name="material_name" id="material_name" value="<?php echo $row['material_name'] ?>" placeholder="Enter Material Name" />
                                                                                           </div>
                                                                                    </div>
                                                                             </div>
                                                                             ...
                                                                             <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <div class="input-group">
                                                                                                  ...
                                                                                                  <input type="text" class="form-control" name="quantity_kg" id="quantity_kg" value="<?php echo $row['quantity_kg'] ?>" placeholder="Enter Quantity in KG" required />
                                                                                           </div>
                                                                                    </div>
                                                                             </div>
                                                                             <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <div class="input-group">
                                                                                                  ...
                                                                                                  <input type="text" class="form-control" name="quantity_nos" id="quantity_nos" value="<?php echo $row['quantity_nos'] ?>" placeholder="Enter Quantity in Nos" required />
                                                                                           </div>
                                                                                    </div>
                                                                             </div>
                                                                             <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <div class="input-group">
                                                                                                  ...
                                                                                                  <input type="text" class="form-control" name="rate" id="rate" value="<?php echo $row['rate'] ?>" placeholder="Enter Rate per unit" required />
                                                                                           </div>
                                                                                    </div>
                                                                             </div>
                                                                             <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <div class="input-group">
                                                                                                  ...
                                                                                                  <input type="text" class="form-control" name="docket_charge" id="docket_charge" value="<?php echo $row['docket_charge'] ?>" placeholder="Enter Docket Charge" />
                                                                                           </div>
                                                                                    </div>
                                                                             </div>
                                                                             <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <div class="input-group">
                                                                                                  ...
                                                                                                  <input type="text" class="form-control" name="cd_charge" id="cd_charge" value="<?php echo $row['cd_charge'] ?>" placeholder="Enter CD Charge" />
                                                                                           </div>
                                                                                    </div>
                                                                             </div>
                                                                             ...
                                                                             <div class="form-group row" id="optClass" style="display:none;" onchange="status1(this);">
                                                                                    ...
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <select class="form-control" name="gst" id="gst">
                                                                                                  ...
                                                                                                  ?>
                                                                                                  <option value="state" <?php echo $state; ?>>State</option>
                                                                                                  <option value="interstate" <?php echo $interstate; ?>>Inter State</option>
                                                                                           </select>
                                                                                    </div>
                                                                             </div>

                                                                             <div class="form-group row" id="gstoptClass1" style="display:none;">
                                                                                    <label class="col-form-label text-right col-lg-3 col-sm-12">CGST% <span style="color:red">*</span></label>
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <div class="input-group">
                                                                                                  <div class="input-group-prepend">
                                                                                                         <span class="input-group-text"><i class="flaticon2-browser"></i></span>
                                                                                                  </div>
                                                                                                  <input type="text" class="form-control" name="cgst" id="cgst" value="<?php echo $row['cgst'] ?>" placeholder="Enter CGST" required />
                                                                                           </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <div class="input-group">
                                                                                                  ...
                                                                                                  <input type="text" class="form-control" name="sgst" id="sgst" value="<?php echo $row['sgst'] ?>" placeholder="Enter SGST" required />
                                                                                           </div>
                                                                                    </div>
                                                                             </div>
                                                                             <div class="form-group row" id="gstoptClass2" style="display:none;">
                                                                                    ...
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <div class="input-group">
                                                                                                  ...
                                                                                                  <input type="text" class="form-control" name="igst" id="igst" value="<?php echo $row['igst'] ?>" placeholder="Enter IGST" />
                                                                                           </div>
                                                                                    </div>
                                                                             </div>
                                                                             <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <div class="input-group">
                                                                                                  ...
                                                                                                  <input type="text" class="form-control" name="agent_commission" id="agent_commission" value="<?php echo $row['agent_commission'] ?>" placeholder="Enter Agent's Commission" />
                                                                                           </div>
                                                                                    </div>
                                                                             </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                               <div class="card card-custom example example-compact">
                                                                             ...
                                                                             <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <div class="input-group">
                                                                                                  ...
                                                                                                  <input type="text" class="form-control" name="to_contact" id="to_contact" value="<?php echo $row['to_contact'] ?>" placeholder="Enter Contact No" />
                                                                                           </div>
                                                                                    </div>
                                                                             </div>
                                                                             ...
                                                                             <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <div class="input-group">
                                                                                                  ...
                                                                                                  <input type="text" class="form-control" name="from_contact" id="from_contact" value="<?php echo $row['from_contact'] ?>" placeholder="Enter Contact No" />
                                                                                           </div>
                                                                                    </div>
                                                                             </div>
                                                                      ...
                                                                      <div class="card-body">
                                                                             ...
                                                                             <div class="form-group row" id="agentoptClass" style="display:none;">
                                                                                    <label class="col-form-label text-right col-lg-3 col-sm-12">Name <span style="color:red">*</span></label>
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <input type="text" class="form-control" name="agent_name" id="agent_name" value="<?php echo $row['agent_name'] ?>" placeholder="Enter your Name" />
                                                                                    </div>
                                                                                    <label class="col-form-label text-right col-lg-3 col-sm-12">Contact No <span style="color:red">*</span></label>
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <div class="input-group">
                                                                                                  ...
                                                                                                  <input type="text" class="form-control" name="agent_contact" id="agent_contact" value="<?php echo $row['agent_contact'] ?>" placeholder="Enter Contact No" />
                                                                                           </div>
                                                                                    </div>
                                                                                    <label class="col-form-label text-right col-lg-3 col-sm-12">City </label>
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <input type="text" class="form-control" name="agent_city" id="agent_city" value="<?php echo $row['agent_city'] ?>" placeholder="Enter your City" />
                                                                                    </div>
                                                                             </div>

                                                                             <div class="form-group row">
                                                                                    <label class="col-form-label text-right col-lg-3 col-sm-12">Delivery Message <span style="color:red">*</span></label>
                                                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                                                           <input type="text" class="form-control" name="delivery_message" id="delivery_message" value="<?php echo $row['delivery_message'] ?>" placeholder="Enter your Delivery Message" />
                                                                                    </div>
                                                                             </div>
                                                                      ...
                                                                      <div class="card-body">
                                                                             ...
                                                                             <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" id="bill_amount" name="bill_amount" value="<?php echo $row['bill_amount'] ?>" class="form-control" disabled="disabled" placeholder="Disabled input" />
                                                                             </div>
                                                                             <div class="form-group">
                                                                                    <label>Sub Total</label>
                                                                                    <input type="text" id="subtotal" name="subtotal" value="<?php echo $row['subtotal'] ?>" class="form-control" disabled="disabled" placeholder="Disabled input" />
                                                                             </div>
                                                                             <div class="form-group">
                                                                                    <label>CGST</label>
                                                                                    <input type="text" id="cgst_value" name="cgst_value" class="form-control" disabled="disabled" placeholder="Disabled input" />
                                                                             </div>
                                                                             <div class="form-group">
                                                                                    <label>SGST</label>
                                                                                    <input type="text" id="sgst_value" name="sgst_value" class="form-control" disabled="disabled" placeholder="Disabled input" />
                                                                             </div>
                                                                             <div class="form-group">
                                                                                    <label>IGST</label>
                                                                                    <input type="text" id="igst_value" name="igst_value" class="form-control" disabled="disabled" placeholder="Disabled input" />
                                                                             </div>
                                                                             <div class="form-group">
                                                                                    <label>Total</label>
                                                                                    <input type="text" id="total" name="total" class="form-control" disabled="disabled" placeholder="Disabled input" />
                                                                             </div>
                                                               ...
                                                               <div class="card-footer">
                                                                      <div class="row">
                                                                             <div class="col-lg-12">
                                                                                    <button type="submit" class="default-btn" name="register" id="submit">Update<i class="flaticon-list-1"></i></button>
                                                                             </div>
                                                                      </div>
                                                               </div>
                                                        </div>
...
<script>
       $(document).ready(function() {
              ...
              $("#bill_amount,#cd_charge,#docket_charge").on("keyup", function() {
                     ...
                     var subtotal = parseInt(bill_amount) + parseInt(docket_charge) + parseInt(cd_charge);
                     //   console.log(subtotal,"total");
                     $("#subtotal").val(subtotal);
              });

              $("#cgst,#subtotal").on("keyup", function() {
                     var subtotal = $("#subtotal").val();
                     var cgst = $("#cgst").val();
                     var cgst_value = subtotal / 100 * cgst;
              ...
              $("#agent_commission").on("keyup", function() {
                     var subtotal = $("#subtotal").val();
                     console.log(subtotal, "sub");
                     var agent_commission = $(this).val();
              ...
              $("#sgst").on("keyup", function() {
                     ...
                     var cgst = $("#cgst").val();
                     var sgst = $(this).val();
                     var total = parseFloat(subtotal) + parseFloat(cgst) + parseFloat(sgst) + parseFloat(agent_commission);
                     $("#total").val(total);
              });
...
<script>
       $(document).ready(function() {
              $("#no_stop").on("change", function() {
                     ...
                     var len = $(this).val();
                     if (len == 1) {
                            $("#emi_list_disp").append('<tr><td><input type="text" name="repayment' + len + '" class="form-control repayment" /></td><td><input type="date" name="advance_date' + len + '" class="form-control" /></td></tr>');
                     } else {
                            var rows = len;
                            for (var i = 0; i < rows; i++) {
                                   $("#emi_list_disp").append('<tr><td><input type="text" name="repayment' + i + '" class="form-control repayment" /></td><td><input type="date" name="advance_date' + i + '" class="form-control" /><input type="hidden" name="balance_amount" id="repayment1' + len + '" readonly class="form-control" /></td></tr>');
                            }
