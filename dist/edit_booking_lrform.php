...
if (isset($_POST['register'])) {
    ...
    $consignment_type1 = $_POST["consignment_type1"];
    ...
    echo $update_otp = "UPDATE base SET customer_type='$customer_type',booking_type='$booking_type',lr_no='$lr_no',consignment_type='$consignment_type',
    company_name='$company_name',invoice_no='$invoice_no',vehicle_halting='$vehicle_halting',unloading_charge='$unloading_charge',invoice_type='$invoice_type',
    internal_info='$internal_info',eway_bill='$eway_bill',
    material_name='$material_name',quantity_kg='$quantity_kg',quantity_nos='$quantity_nos',rate='$rate',
    docket_charge='$docket_charge',gst='$gst',gstamount='$gstamount',agent_commission='$agent_commission',
        bill_amount='$bill_amount',subtotal='$subtotal',gstamount_value='$gstamount_value',total='$total'
                                ...
                                <div class="col-lg-6">
                                    <div class="card card-custom gutter-b  example-compact">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <input type="text" class="form-control" name="lr_no" id="lr_no" value="<?php echo $row['lr_no']; ?>" placeholder="Enter your LR No" />
                                            ...
                                            <!--    </div>-->
                                            <!--</div>-->
                                            <div class="form-group row" id="optClass99" style="display:none;">
                                                <label class="col-form-label text-right col-lg-3 col-sm-12">Consignment Type <span style="color:red">*</span></label>
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <select class="form-control" name="consignment_type1" id="consignment_type1" required>
                                            ...
                                            <div class="form-group row" id="optClass109">
                                                <label class="col-form-label text-right col-lg-3 col-sm-12">Consignment Type <span style="color:red">*</span></label>
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                            ...
                                            <div class="form-group row" id="browser" style="display:none;">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    ...
                                                    <datalist id="browsers">
                                                        ...
                                                        <?php
                                                        echo $sql = "select distinct company_name from company";
                                                        ...
                                                        while ($allfilter = $result->FETCH_ASSOC()) {
                                                            ...
                                                            echo '<option>' . $allfilter["company_name"] . '<?php echo $selected_combos;?></option>';
                                                        }
                                                        ?>
                                                </div><br><br>
                                                </datalist>
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <input type="text" class="form-control" name="invoice_no" id="invoice_no" value="<?php echo $row['invoice_no'] ?>"  placeholder="Enter your Invoice No" />
                                                </div><br><br>
                                            </div>
                                    ...
                                    <div class="card card-custom gutter-b  example-compact">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="quantity_kg" id="quantity_kg" value="<?php echo $row['quantity_kg'] ?>" placeholder="Enter Quantity in KG" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="quantity_nos" id="quantity_nos" value="<?php echo $row['quantity_nos'] ?>" placeholder="Enter Quantity in Nos" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="rate" id="rate" value="<?php echo $row['rate'] ?>" placeholder="Enter Rate per unit" />
                                                    </div>
                                                </div>
                                            </div>
                                            &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;
                                            <input type="radio" id="quantity_kg_radio" name="quantitynos_radio" value="quantity_kg" >
                                            <label for="quantity_kg">Quantity in KG</label>&ensp;&ensp;&ensp;&ensp;&ensp;
                                            <input type="radio" id="quantity_nos_radio" name="quantitynos_radio" value="quantity_nos" >
                                            ...
                                            <div class="form-group row" id="gstoptClass1" style="display:none;">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="gstamount" id="gstamount" value="<?php echo $row['gstamount'] ?>" placeholder="Enter GST Amount" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <!--                <span class="input-group-text"><i class="flaticon2-browser"></i></span>-->
                                            <!--            </div>-->
                                            <!--            <input type="text" class="form-control" name="cgst" id="cgst" value="<?php echo $row['cgst'] ?>" placeholder="Enter CGST" />-->
                                            <!--        </div>-->
                                            <!--    </div>-->
                                            ...
                                            <!--                <span class="input-group-text"><i class="flaticon2-browser"></i></span>-->
                                            <!--            </div>-->
                                            <!--            <input type="text" class="form-control" name="sgst" id="sgst" value="<?php echo $row['sgst'] ?>" placeholder="Enter SGST" />-->
                                            <!--        </div>-->
                                            <!--    </div>-->
                                            <!--</div>-->
                                            ...
                                            <div class="form-group row" id="optClass59" style="display:none;">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="vehicle_halting" id="vehicle_halting" value="<?php echo $row['vehicle_halting'] ?>" placeholder="Enter Vehicle Halting No" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="unloading_charge" id="unloading_charge" value="<?php echo $row['unloading_charge'] ?>" placeholder="Enter Unloading Charge " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-primary font-weight-bold" name="register" id="submit">Update</button>
                                            <a href="#" class="btn btn-light-danger font-weight-bold" onclick="history.go(-1)">Go Back</a>
                                    ...
                                    <div class="card card-custom gutter-b  example-compact">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="bill_amount" name="bill_amount" value="<?php echo $row['bill_amount'] ?>" class="form-control" readonly placeholder="Disabled input" />
                                            </div>
                                            <div class="form-group">
                                                <label>Sub Total</label>
                                                <input type="text" id="subtotal" name="subtotal" value="<?php echo $row['subtotal'] ?>" class="form-control" readonly placeholder="Disabled input" />
                                            </div>
                                            <div class="form-group">
                                                <label>CGST</label>
                                                <input type="text" id="cgst_value" name="cgst_value" value="<?php echo $row['cgst_value'] ?>" class="form-control" readonly placeholder="Disabled input" />
                                            </div>
                                            <div class="form-group">
                                                <label>SGST</label>
                                                <input type="text" id="sgst_value" name="sgst_value" value="<?php echo $row['sgst_value'] ?>" class="form-control" readonly placeholder="Disabled input" />
                                            </div>
                                            <div class="form-group">
                                                <label>IGST</label>
                                                <input type="text" id="igst_value" name="igst_value" value="<?php echo $row['igst_value'] ?>" class="form-control" readonly placeholder="Disabled input" />
                                            </div>
                                            <div class="form-group">
                                                <label>Total</label>
                                                <input type="text" id="total" name="total" class="form-control" value="<?php echo $row['total'] ?>" readonly placeholder="Disabled input" />
                                            </div>
