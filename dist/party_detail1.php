...
// $sql = "DELETE FROM party WHERE bill_id='$delete'";
// 	if ($conn->query($sql)) {
// 	   // exit();
...
if(isset($_POST['deletebill'])){
    ...
    echo  $sql = "DELETE FROM party WHERE bill_id='$bill_id'";
    $exe=$conn->query($sql);
    if($exe)
    {
         ...
         $sql217 = "SELECT * FROM base WHERE bill_id='$bill_id'";
					...
					$sql22 = "update base set bill_id='',status1='0' WHERE bill_id='$bill_id'";
				           if ($conn->query($sql22)) {
				           }
				...
				<div class="card card-custom">
					...
					<div class="card-body">
										...
										?>
											...
											<div class="table-responsive">
												<table class="table table-separate table-head-custom table-checkable" id="example5">
													...
													<tbody>
														<?php
														$sql5 = "SELECT * FROM base where customer_type='party' && from_name='$from_name' && status1=0 order by id desc";
												...
												<table style="display:none" class="table table-separate table-head-custom table-checkable" id="kt_datatable2">
													...
													<tbody>
														...
														?>
															<tr>
																<td><?php echo $j++ ?></td>
																<td><?php echo $delivery["from_name"] ?></a></td>
																<td><?php echo $delivery["to_name"] ?></a></td>
																<td><?php echo $delivery["lr_no"] ?></td>
																<td><?php echo $delivery["to_address"] ?></td>
																<td><?php echo $delivery["from_cx_id"] ?></td>
																...
																<td><?php echo $delivery["amount_enter"] ?></td>
										...
										?>
												...
												<div class="table-responsive">
													<table style="display:none" class="table table-separate table-head-custom table-checkable" id="kt_datatable2">
														...
														<tbody>
															<?php
															$sql9 = "SELECT * FROM base where customer_type='party' && from_name='$from_name' AND status1=0 AND createddate >='$fromdate' AND createddate <='$todate' ";
															...
															?>
																...
																<!--	</td>-->
																<!--	<td>-->
																<!--		<?php echo $allfilter["createdAt"] ?>-->
																<!--	</td>-->
																<!--	<td>-->
																<!--		<?php echo $allfilter["from_name"] ?></a>-->
																<!--	</td>-->
																<!--	<td>-->
																<!--		<?php echo $allfilter["lr_no"] ?>-->
																<!--	</td>-->
																<!--	<td>-->
																<!--		<?php echo $allfilter["quantity_nos"] ?>-->
																<!--	</td>-->
																<!--	<td>-->
																<!--		<?php echo $allfilter["quantity_kg"] ?>-->
																<!--	</td>-->
																<!--	<td>-->
																<!--		<?php echo $allfilter["rate"] ?>-->
																<!--	</td>-->
																<!--	<td>-->
																<!--		<?php echo $allfilter["total"] ?>-->
																<!--	</td>-->
																<!--	<td>-->
																<!--		<?php echo $allfilter["amount_enter"] ?>-->
																<!--	</td>-->
																<!--</tr>-->
															<?php
															}
												...
												<div class="table-responsive" id="productoptClass26">
													<table class="table table-separate table-head-custom table-checkable" id="example7">
														...
														<tbody>
															...
															$insert = "INSERT into party (id,bill_id,from_cx_id,name,from_contact,from_address,to_address,total1,paymnent,balance,from_date,to_date,branch1,username1,createddate1) 
                            values('$id','$bill_id','$from_cx_id','$from_name','$from_contact','$from_address','$to_address','$s','$s1','$s2','$fromdate','$todate','$branch','$username','$createddate')";
															if (mysqli_query($conn, $insert)) {
																$sql2 = "update base set status1=1,bill_id='$bill_id' where from_name='$from_name' AND createddate >='$fromdate' AND createddate <='$todate' AND customer_type='party' AND status1!=1 ";
								...
								<div id="partybill" class="container tab-pane">
									<div class="table-responsive">
										<table class="table table-separate table-head-custom table-checkable" id="example5">
											...
											<tbody>
												<?php
												$sql5 = "SELECT * FROM party where name='$from_name' order by bill_id asc";
												$result5 = $conn->query($sql5);
												$j = 1;
												$s = 0;
												$s1 = 0;
												...
												while ($delivery = $result5->FETCH_ASSOC()) {
													...
													$sql51 = "SELECT * FROM base where from_name='$from_name' and bill_id='$bill_id'";
													$result51 = $conn->query($sql51);
													$delivery51 = $result51->FETCH_ASSOC();
														$amount_paid1 = $delivery51["amount_paid1"];

														$sql50 = "SELECT id,from_cx_id,name,from_contact,to_address,mode_payment,amount_enter,payment_date,createdAt11,SUM(total1) as total1,SUM(paymnent) as paymnent,SUM(balance) as balance FROM party where name='$from_name' and bill_id='$bill_id' GROUP BY name";
															...
															<tr>
																...
																<form method="POST">
																    <input type="hidden" value="<?=$delivery["bill_id"]?>" name="bill_id" />
																     <button type="submit" name="deletebill"><i class="la la-trash"></i></button>
																</form>
									...
									<!--                                    <input type="text" name="id" id="allloading_user_id">-->
											...
											<div class="table-responsive">
												<table class="table table-separate table-head-custom table-checkable" id="example5">
													...
													<tbody>
														...
														$sql5 = "SELECT * FROM base where customer_type='party' && from_name='$from_name' ";
														$result5 = $conn->query($sql5);
														$j = 1;
														while ($delivery = $result5->FETCH_ASSOC()) {

															
															$sql51 = "SELECT * FROM party where name='$from_name' ";
															$result51 = $conn->query($sql51);
															$delivery1 = $result51->FETCH_ASSOC();

															$sql50 = "SELECT id,from_cx_id,name,from_contact,to_address,mode_payment,amount_enter,payment_date,createdAt11,SUM(total1) as total1,SUM(paymnent) as paymnent,SUM(balance) as balance FROM party where name='$from_name' GROUP BY name";
															$result50 = $conn->query($sql50);
															while ($delivery50 = $result50->FETCH_ASSOC()) {
														...
														?>
																<tr>
																	...
																	<td>
																		<?php echo $delivery11["amount_enter"] ?>
																	</td>
																	<td>
																		<?php echo $delivery["to_address"] ?>
																	</td>
																	<td>
																		<?php echo $delivery1["payment_date"] ?>
																	</td>
																	<td>
																		<a href="lrdatatable.php?del=<?php echo $delivery["id"] ?>" onclick="myFunction()" class="btn btn-sm btn-clean btn-icon" title="Delete">
																			<i class="la la-trash"></i>
						...
						?>
										...
										?>
											...
											<div class="table-responsive">
												<table class="table table-separate table-head-custom table-checkable" id="example5">
													...
													<tbody>
														<?php
														$sql5 = "SELECT * FROM base where customer_type='party' && from_name='$from_name' && status1=0 && branch = '$branch'  order by id desc";
														$result5 = $conn->query($sql5);
														$j = 1;
														$s = 0;
														$s1 = 0;
										...
										?>
												...
												<div class="table-responsive">
													<table style="display:none" class="table table-separate table-head-custom table-checkable" id="kt_datatable2">
														...
														<tbody>
															<?php
															$sql9 = "SELECT * FROM base where customer_type='party' && from_name='$from_name' AND status1=0 AND createddate >='$fromdate' AND createddate <='$todate' && branch = '$branch'";
															$result9 = $conn->query($sql9);
															$j = 1;
															$s = 0;
															$s1 = 0;
                            ...
                            values('$id','$bill_id','$from_cx_id','$from_name','$from_contact','$from_address','$to_address','$s','$s1','$s2','$fromdate','$todate','$branch','$username','$createddate')";
															if (mysqli_query($conn, $insert)) {
																$sql2 = "update base set status1=1,bill_id='$bill_id' where from_name='$from_name' AND createddate >='$fromdate' AND createddate <='$todate' AND status1!=1 AND customer_type='party' && branch = '$branch' ";
																if (mysqli_query($conn, $sql2)) {
																}
															}
															?>
								...
								<div id="partybill" class="container tab-pane">
									<div class="table-responsive">
										<table class="table table-separate table-head-custom table-checkable" id="example5">
											...
											<tbody>
												<?php
												$sql5 = "SELECT * FROM party where name='$from_name' && branch = '$branch' order by bill_id desc";
												$result5 = $conn->query($sql5);
												$j = 1;
												$s = 0;
												$s1 = 0;
												...
												while ($delivery = $result5->FETCH_ASSOC()) {
													...
													$sql51 = "SELECT * FROM base where from_name='$from_name' and bill_id='$bill_id' && branch = '$branch'";
													$result51 = $conn->query($sql51);
													$delivery51 = $result51->FETCH_ASSOC();
														$amount_paid1 = $delivery51["amount_paid1"];

														$sql50 = "SELECT id,from_cx_id,name,from_contact,to_address,mode_payment,amount_enter,payment_date,createdAt11,SUM(total1) as total1,SUM(paymnent) as paymnent,SUM(balance) as balance FROM party where name='$from_name' && bill_id='$bill_id' && branch1 = '$branch' GROUP BY name";
														$result50 = $conn->query($sql50);
														while ($delivery50 = $result50->FETCH_ASSOC()) {
															$del =  $delivery50["balance"] - $delivery51["amount_paid1"];
										...
										?>
											<div class="table-responsive">
												<table class="table table-separate table-head-custom table-checkable" id="example5">
													...
													<tbody>
														<?php
														$sql5 = "SELECT * FROM base where customer_type='party' && from_name='$from_name' && branch = '$branch'";
														$result5 = $conn->query($sql5);
														$j = 1;
														while ($delivery = $result5->FETCH_ASSOC()) {

															$sql51 = "SELECT * FROM party where name='$from_name' && branch1 = '$branch'";
															$result51 = $conn->query($sql51);
															$delivery1 = $result51->FETCH_ASSOC();

															$sql50 = "SELECT id,from_cx_id,name,from_contact,to_address,mode_payment,amount_enter,payment_date,createdAt11,SUM(total1) as total1,SUM(paymnent) as paymnent,SUM(balance) as balance FROM party where name='$from_name' && branch1 = '$branch' GROUP BY name";
															$result50 = $conn->query($sql50);
															while ($delivery50 = $result50->FETCH_ASSOC()) {
																$del =  $delivery50["balance"] - $delivery51["amount_paid1"];
						...
						?>
										...
										?>
											...
											<div class="table-responsive">
												<table class="table table-separate table-head-custom table-checkable" id="example5">
													...
													<tbody>
														<?php
														$sql5 = "SELECT * FROM base where customer_type='party' && from_name='$from_name' && status1=0 && branch = '$branch' && username = '$username' order by id desc";
														$result5 = $conn->query($sql5);
														$j = 1;
														$s = 0;
														$s1 = 0;
										...
										?>
												...
												<div class="table-responsive">
													<table style="display:none" class="table table-separate table-head-custom table-checkable" id="kt_datatable2">
														...
														<tbody>
															<?php
															$sql9 = "SELECT * FROM base where customer_type='party' && from_name='$from_name' AND status1=0 AND createddate >='$fromdate' AND createddate <='$todate' && branch = '$branch' && username = '$username'";
															$result9 = $conn->query($sql9);
															$j = 1;
															$s = 0;
															$s1 = 0;
                            ...
                            values('$id','$bill_id','$from_cx_id','$from_name','$from_contact','$from_address','$to_address','$s','$s1','$s2','$fromdate','$todate','$branch','$username','$createddate')";
															if (mysqli_query($conn, $insert)) {
																$sql2 = "update base set status1=1,bill_id='$bill_id' where from_name='$from_name' AND createddate >='$fromdate' AND createddate <='$todate' AND status1!=1 AND customer_type='party' && branch = '$branch' && username = '$username'";
																if (mysqli_query($conn, $sql2)) {
																}
															}
															?>
								...
								<div id="partybill" class="container tab-pane">
									<div class="table-responsive">
										<table class="table table-separate table-head-custom table-checkable" id="example5">
											...
											<tbody>
												<?php
												$sql5 = "SELECT * FROM party where name='$from_name' && branch1 = '$branch' && username1 = '$username' order by bill_id desc";
												$result5 = $conn->query($sql5);
												$j = 1;
												while ($delivery = $result5->FETCH_ASSOC()) {
													$bill_id = $delivery["bill_id"];

													$sql51 = "SELECT * FROM base where from_name='$from_name' and bill_id='$bill_id' && branch = '$branch' && username = '$username'";
													$result51 = $conn->query($sql51);
													$delivery51 = $result51->FETCH_ASSOC();
														$amount_paid1 = $delivery51["amount_paid1"];

														$sql50 = "SELECT id,from_cx_id,name,from_contact,to_address,mode_payment,amount_enter,payment_date,createdAt11,SUM(total1) as total1,SUM(paymnent) as paymnent,SUM(balance) as balance FROM party where name='$from_name' && branch1 = '$branch' && username1 = '$username'GROUP BY name";
														$result50 = $conn->query($sql50);
														while ($delivery50 = $result50->FETCH_ASSOC()) {
															$del =  $delivery50["balance"] - $delivery51["amount_paid1"];
										...
										?>
											<div class="table-responsive">
												<table class="table table-separate table-head-custom table-checkable" id="example5">
													...
													<tbody>
														<?php
														$sql5 = "SELECT * FROM base where customer_type='party' && from_name='$from_name' && branch = '$branch' && username = '$username'";
														$result5 = $conn->query($sql5);
														$j = 1;
														while ($delivery = $result5->FETCH_ASSOC()) {

															$sql51 = "SELECT * FROM party where name='$from_name' && branch1 = '$branch' && username1 = '$username'";
															$result51 = $conn->query($sql51);
															$delivery1 = $result51->FETCH_ASSOC();

															$sql50 = "SELECT id,from_cx_id,name,from_contact,to_address,mode_payment,amount_enter,payment_date,createdAt11,SUM(total1) as total1,SUM(paymnent) as paymnent,SUM(balance) as balance FROM party where name='$from_name' && branch = '$branch' && username = '$username' GROUP BY name";
															$result50 = $conn->query($sql50);
															while ($delivery50 = $result50->FETCH_ASSOC()) {
																$del =  $delivery50["balance"] - $delivery51["amount_paid1"];
										...
										?>
												<div class="table-responsive">
													<table class="table table-separate table-head-custom table-checkable" id="example5">
														...
														<tbody>
															<?php
															$sql5 = "SELECT * FROM base where customer_type='party' && from_name='$from_name' && branch = '$branch' && username = '$username' && createddate >='$fromdate1' AND createddate <='$todate1'";
															$result5 = $conn->query($sql5);
															$j = 1;
															while ($delivery = $result5->FETCH_ASSOC()) {
																...
																$sql50 = "SELECT id,from_cx_id,name,from_contact,to_address,mode_payment,amount_enter,payment_date,payment_date,payment_date,createdAt11,SUM(total1) as total1,SUM(paymnent) as paymnent,SUM(balance) as balance FROM party where name='$from_name' && branch1 = '$branch' && username1 = '$username' GROUP BY name";
																$result50 = $conn->query($sql50);
																while ($delivery50 = $result50->FETCH_ASSOC()) {
																	$del =  $delivery50["balance"] - $delivery51["amount_paid1"];
