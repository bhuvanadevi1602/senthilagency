...
<div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
	...
	<div class="alert-text">
		The Metronic KTDatatable supports vertical scrolling with fixed height.local or remote data source. For the local data you can pass javascript array as data source. In this example the grid fetches its
		data from a javascript array data source. For more information visit <a class="font-weight-bold" href="https://keenthemes.com/metronic/?page=docs&section=html/components/datatable" target="_blank">Metronic KTDatatable Documentation</a>.
	</div>
</div>
<!--end::Notice-->
...
</svg><!--end::Svg Icon--></span> Create User
</a>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <input type="text" class="form-control" name="internal_info" id="internal_info" placeholder="Enter your Name" />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <select class="form-control" name="consignment_type" id="consignment_type">
                                                        ...
                                                        <option value="pay">Admin</option>
                                                        <option value="month">User</option>
                                    ...
                                    <div class="form-group row">
                                                <label class="col-form-label text-right col-lg-3 col-sm-12">Branch<span style="color:red">*</span></label>
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <select class="form-control" name="consignment_type" id="consignment_type">
                                                        <option selected disabled>Select</option>
                                                        
                                                        <option value="pay">1</option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-12">
                                                    <input type="text" class="form-control" name="internal_info" id="internal_info" placeholder="Enter your Username" />
                                                    <span class="form-text text-muted">We'll never share your Username with anyone else.</span>
                                                </div>
                                            </div>
                                            <div class="form-group row">
