...
<head>
    <meta charset="utf-8" />
    <title>Senthil Agency | Login Page</title>
...
<body id="kt_body" class="header-mobile-fixed subheader-enabled aside-enabled aside-fixed aside-secondary-enabled page-loading">
    ...
    if (isset($_POST['log_in'])) {
        ...
        $sql = "select * from add_user where user_name='$username' and password='$password'";
        ...
        if (mysqli_num_rows($result) != 0) {
            ...
            // if ($active_state == 1) {
                ...
                $_SESSION['courier_mode'] = $row['courier_mode'];
                $_SESSION['role'] = $row['role'];
                $_SESSION['name'] = $row['name'];
                $_SESSION['active_state'] = $row['active_state'];
            ...
            //       text: 'You don\'t have authority right now to access!',
            //       icon: 'error',
            ...
            echo "<script type='text/javascript'>
                  ...
                  text: 'This account doesn\'t exist.Try again !',
                  icon: 'error',
                  confirmButtonColor: '#086ad7',
                  button: 'Dashboard!',
                            });
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="login login-2 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
                ...
                <div class="d-flex flex-column-fluid flex-column justify-content-between py-9 px-7 py-lg-13 px-lg-35">
                    ...
                    <div class="d-flex flex-column-fluid flex-column flex-center">
                        ...
                        <div class="login-form login-signin py-11">
                            <!--begin::Form-->
                            <form class="form" novalidate="novalidate" id="" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" name="login_form" onsubmit="return validate()">
                                <!--begin::Title-->
                                <div class="text-center pb-8">
                                    <h2 class="font-weight-bolder font-size-h2 font-size-h1-lg" style="color:#086ad7;">Login</h2>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="text-danger text-capitalize" id="username_error_element"></span>
                                </div>
                                <!--end::Form group-->
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="text-danger text-capitalize" id="password_error_element"></span>
                                </div>
                                <!--end::Form group-->

                                <!--begin::Action-->
                                <div class="text-center pt-2">
                                    <button type="submit" id="" class="btn btn-dark font-weight-bolder font-size-h6 px-8 py-4 my-3" name="log_in">Login</button>
                                </div>
                                <!--end::Action-->
                            </form>
                            <!--end::Form-->
            ...
            <!--begin::Content-->
            <div class="content d-flex flex-column w-100 pb-0" style="background-color: #086ad7;">
                <!--begin::Title-->
                <div class="d-flex flex-column justify-content-center text-center pt-lg-10 pt-md-2 pt-sm-2 px-lg-0 pt-5 px-7">
                    <h3 class="display4 font-weight-bolder my-4 text-dark" style="color: #ffff !important;">SA</h3>
                ...
                <!--begin::Image-->
                <div class="content-img d-flex flex-row-fluid bgi-no-repeat  bgi-position-x-center " style="background-image: url(assets/media/svg/illustrations/login-visual-1.svg);"></div>
                <!--end::Image-->
            </div>
            <!--end::Content  order-1 order-lg-2  -->
        </div>
        <!--end::Login-->
    </div>
    <!--end::Main-->
    ...
    <script>
        function validate() {
            var user_name = document.forms['login_form']['username'].value;

            var password = document.forms['login_form']['password'].value;

            if (user_name != '') {
                document.getElementById('username_error_element').innerHTML = '';
            } else {

                document.getElementById('username_error_element').innerHTML = 'please enter username';
                return false;
            }
            ...
            if (password != '') {
                document.getElementById('password_error_element').innerHTML = '';
            } else {

                document.getElementById('password_error_element').innerHTML = 'please enter username';
                return false;
            }
        }
    </script>
