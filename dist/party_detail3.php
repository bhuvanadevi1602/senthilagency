...
//       $delete = "DELETE FROM base WHERE id='$del'";
//       if ($conn->query($delete)) {
//           echo '<script>alert("sweet")</script>';
...
if (isset($_POST['deletebill'])) {
    ...
    if ($exe) {
        ...
        $sql217 = "SELECT * FROM base WHERE bill_id='$bill_id'";
        $result27 = $conn->query($sql217);
        $branchTable = $result27->fetch_assoc();
        $bill_id = $branchTable['bill_id'];
        $status1 = $branchTable['status1'];

        $sql22 = "update base set bill_id='',status1='0',amount_paid1='',already_paid1='',pymt_date='' WHERE bill_id='$bill_id'";
        if ($conn->query($sql22)) {
        }
...
if (isset($_POST['deletepartydetail'])) {
    ...
    $delete1 = "DELETE FROM party WHERE bill_id='$bill_id'";
    if ($conn->query($delete1)) {
       $delete = "DELETE FROM base WHERE bill_id='$bill_id'";
       if ($conn->query($delete)) {
         header("Location: lrdatatable.php?&msg= Deleted!");
	    }
    }
                                ...
                                <div id="party" class="container tab-pane active"><br>
                                    <div class="table-responsive">
                                        ...
                                        ?>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-separate table-head-custom table-checkable" id="example5">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $sql5 = "SELECT * FROM base where customer_type='party' && from_cx_id='$from_cx_id' && status1=0 order by id desc";
                                                        ...
                                                        while ($delivery = $result5->FETCH_ASSOC()) {
                                                            ...
                                                            $string2 =  (int) $delivery["total"]  - (int) $delivery["amount_enter"];
                                                            $s2 = $s2 + $string2;
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td><a href="lrform_detail.php?id=<?php echo $delivery["id"] ?>">
                                                                ...
                                                                <td>
                                                                    <?php echo $delivery["quantity_nos"] ?>
                                                                </td>
                                                                <td>
                                                                    <?php echo $delivery["quantity_kg"] ?>
                                                                </td>
                                                                <td>
                                                                    <?php echo $delivery["rate"] ?></a>
                                                                </td>
                                                                <td>
                                                                    <?php echo $delivery["total"] ?>
                                                                </td>
                                                                <!--<td>-->
                                                                <!--  <?php echo $delivery["amount_enter"] ?>-->
                                                                <!--</td>-->
                                                                <td>
                                                                    <?php echo  $delivery["total"] - $delivery["amount_enter"] ?>
                                                                </td>
                                                                <td>
                                        ...
                                        ?>
                                                ...
                                                <div class="table-responsive" id="productoptClass26">
                                                    <table class="table table-separate table-head-custom table-checkable" id="example7">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $sql9 = "SELECT * FROM base where customer_type='party' && from_cx_id='$from_cx_id' AND status1=0 AND createddate >='$fromdate' AND createddate <='$todate' ";
                                                            ...
                                                            $sql2 = "update base set status1=0 where from_cx_id='$from_cx_id' AND createddate >='$fromdate' AND createddate <='$todate' AND customer_type='party' AND status1!=1 ";
                                        ...
                                        ?>
                                            ...
                                            <div class="table-responsive">
                                                <table style="display:none" class="table table-separate table-head-custom table-checkable" id="kt_datatable2">
                                                    <thead>
                                                        <tr>
                                                            <th>S.No</th>
                                                            <th>From Name</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        while ($allfilter = $result9->FETCH_ASSOC()) {
                                                            ...
                                                            $string =  (int) $allfilter["total"];
                                                            $s = $s + $string;

                                                            $string1 =  (int) $allfilter["amount_enter"];
                                                            $s1 = $s1 + $string1;

                                                            $string2 =  (int) $allfilter["total"] - (int) $allfilter["amount_enter"];
                                                            $s2 = $s2 + $string2;
                                                        ?>
                                                            <tr>
                                                                <td><?php echo $j++ ?></td>
                                                                <td><?php echo $allfilter["from_name"] ?></a></td>
                                                                <td><?php echo $allfilter["to_name"] ?></a></td>
                                                                <td><?php echo $allfilter["lr_no"] ?></td>
                                                                <td><?php echo $allfilter["to_address"] ?></td>
                                                                <td><?php echo $allfilter["from_cx_id"] ?></td>
                                                                <td><?php echo $allfilter["quantity_nos"] ?></td>
                                                                <td><?php echo $allfilter["quantity_kg"] ?></td>
                                                                <td><?php echo $allfilter["rate"] ?></td>
                                                        ...
                                                        $insert = "INSERT into party (id,bill_id,from_cx_id,name,from_contact,from_address,to_address,total1,paymnent,balance,from_date,to_date,branch1,username1,createddate1,partyend_time) 
                                                          values('$id','$bill_id','$from_cx_id','$from_name','$from_contact','$from_address','$to_address','$s','$s1','$s2','$fromdate','$todate','$branch','$username','$createddate','$partyend_time')";
                                                        if (mysqli_query($conn, $insert)) {
                                                            $sql2 = "update base set status1=1,bill_id='$bill_id' where from_cx_id='$from_cx_id' AND createddate >='$fromdate' AND createddate <='$todate' AND customer_type='party' AND status1!=1 ";
                                                            if (mysqli_query($conn, $sql2)) {
                                                            }
                                                        }
                                                        ?>
                                        ...
                                        <table class="table table-separate table-head-custom table-checkable" id="example5">
                                            ...
                                            <tbody>
                                                ...
                                                while ($delivery = $result5->FETCH_ASSOC()) {
                                                    ...
                                                    $sql51 = "SELECT * FROM base where from_cx_id='$from_cx_id' and bill_id='$bill_id'";
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <!--<li class="navi-item"><a href="lrdatatable.php?id=<?php echo $allfilter["id"] ?>" id="<?php echo $allfilter["id"] ?>" class="navi-link allloading_branch" data-toggle="modal" data-target="#alllocation_user"><i class="fa fa-spinner"></i>&ensp;Loading</a></li>-->
                                                            <!--<td><a href="party_detail.php?bill_id=<?php echo $delivery["bill_id"] ?>" bill_id="<?php echo $delivery["bill_id"] ?>" class="navi-link allloading_branch" data-toggle="modal" data-target="#exampleModal"><?php echo $delivery["bill_id"] ?></a></td>-->
                                                            <td>
                                                            ...
                                                            <!--<td>-->
                                                            <!--	<?php echo $delivery51["amount_paid1"] ?>-->
                                                            <!--</td>-->
                                                            <td>
                                                                <?php echo $delivery51["createdAt"] ?>
                                                            </td>
                                                            <td>
                                                                <?php
                                                                ...
                                                                ?>
                                                                <!--<a href="lrdatatable.php?delete=<?php echo $delivery["bill_id"] ?>" onclick="myFunction()" class="btn btn-sm btn-clean btn-icon" title="Delete">-->
                                                                <!--	<i class="la la-trash"></i>-->
                                                                <!--</a>-->
                                                            </td>
                                                        </tr>
                                        ...
                                        ?>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-separate table-head-custom table-checkable" id="example5">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        // $sql5 = "SELECT * FROM base join party ON base.bill_id = party.bill_id where customer_type='party' && from_name='$from_name' ";
                                                        $sql5 = "SELECT * FROM base where customer_type='party' && from_cx_id='$from_cx_id' and status1=1";
                                                        $result5 = $conn->query($sql5);
                                                        $j = 1;
                                                        while ($delivery = $result5->FETCH_ASSOC()) {
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php echo $delivery["amount_paid1"] ?>
                                                                    </td>
                                                                    <td>
                                                                        <?php echo $delivery["to_address"] ?>
                                                                    </td>
                                                                    <td>
                                                                        <?php echo $delivery["pymt_date"] ?>
                                                                    </td>
                                                                    <td>
                                                                    <form method="POST">
                                                                        <input type="hidden" value="<?= $delivery["bill_id"] ?>" name="bill_id" />
                                                ...
                                                <table style="display:none" class="table table-separate table-head-custom table-checkable" id="kt_datatable3">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
																...
																<td><?php echo $delivery["invoice_type"] ?></td>
																<td><?php echo $delivery["material_name"] ?></td>
																<td><?php echo $delivery["docket_charge"] ?></td>
                                                                    <td>
                                                                        <?php echo $delivery["total"] ?>
                                                                    </td>
                                                                    <td>
                                        ...
                                        ?>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-separate table-head-custom table-checkable" id="example5">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $sql5 = "SELECT * FROM base where customer_type='party' && from_cx_id='$from_cx_id' && createddate >='$fromdate1' AND createddate <='$todate1'  AND status1=1";
                                                            $result5 = $conn->query($sql5);
                                                            $j = 1;
                                                            while ($delivery = $result5->FETCH_ASSOC()) {
                                                                ...
                                                                while ($delivery50 = $result50->FETCH_ASSOC()) {
                                                                    ...
                                                                    $string1 =  (int) $delivery["amount_paid1"];
                                                                    $s1 = $s1 + $string1;
                                                            ?>
                                                                    <tr>
                                                                        <td>
                                                                        ...
                                                                        <td>
                                                                            <?php echo $delivery["lr_no"] ?>
                                                                        </td> <?php echo $delivery["from_cx_id"] ?>
                                                                        </td>
                                                                        <td>
                                                                            <?php echo $delivery["createdAt"] ?>
                                                                        </td>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            while ($delivery = $result5->FETCH_ASSOC()) {
                                                                ...
                                                                while ($delivery50 = $result50->FETCH_ASSOC()) {
                                                                    ...
                                                                    $string1 =  (int) $delivery["total"] - (int) $delivery["amount_paid1"];
                                                                    $s1 = $s1 + $string1;
                                                            ?>
                                                                    <tr>
                                                                        <td>
                                        ...
                                        ?>
                                            <div class="table-responsive">
                                                <table class="table table-separate table-head-custom table-checkable" id="example5">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $sql5 = "SELECT * FROM base where customer_type='party' && from_cx_id='$from_cx_id'";
                                                        $result5 = $conn->query($sql5);
                                                        $j = 1;
                                                        while ($delivery = $result5->FETCH_ASSOC()) {
                                                        ?>
                                                ...
                                                <table style="display:none" class="table table-separate table-head-custom table-checkable" id="kt_datatable1">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        while ($delivery = $result5->FETCH_ASSOC()) {
                                                            ...
                                                            $sql50 = "SELECT SUM(total) as total FROM base where customer_type='party' && from_cx_id='$from_cx_id'";
                                                            $result50 = $conn->query($sql50);
                                                            while ($delivery50 = $result50->FETCH_ASSOC()) {
                                                        $s = 0;
                                        ...
                                        ?>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-separate table-head-custom table-checkable" id="example5">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $sql5 = "SELECT * FROM base where customer_type='party' && from_cx_id='$from_cx_id' && createddate >='$fromdate3' AND createddate <='$todate3'";
                                                            $result5 = $conn->query($sql5);
                                                            $j = 1;
                                                            while ($delivery = $result5->FETCH_ASSOC()) {
                                                            ?>
                                                ...
                                                <div class="table-responsive">
                                                    <table style="display:none" class="table table-separate table-head-custom table-checkable" id="kt_datatable1">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $j = 1;
                                                            while ($delivery = $result5->FETCH_ASSOC()) {
                                                                 $sql50 = "SELECT SUM(total) as total FROM base where customer_type='party' && from_cx_id='$from_cx_id' && createddate >='$fromdate3' AND createddate <='$todate3'";
                                                            $result50 = $conn->query($sql50);
                                                            while ($delivery50 = $result50->FETCH_ASSOC()) {
                                                        $s = 0;
                                                        ...
                                                        $s = $s + $string;
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php echo $delivery["from_name"] ?></td>
                                                                    <td>
                                                                        <?php echo $delivery["lr_no"] ?>
                                                                    </td>
                                                                    <td>
                                        ...
                                        ?>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-separate table-head-custom table-checkable" id="example5">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $sql5 = "SELECT * FROM base where customer_type='party' && from_cx_id='$from_cx_id' && status1=0 && branch = '$branch'  order by id desc";
                                                        $result5 = $conn->query($sql5);
                                                        $j = 1;
                                                        $s = 0;
                                                        $s1 = 0;
                                        ...
                                        ?>
                                                ...
                                                <div class="table-responsive" id="productoptClass26">
                                                    <table class="table table-separate table-head-custom table-checkable" id="example7">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $sql9 = "SELECT * FROM base where customer_type='party' && from_cx_id='$from_cx_id' AND status1=0 AND createddate >='$fromdate' AND createddate <='$todate' && branch = '$branch'";
                                                            $result5 = $conn->query($sql9);
                                                            $j = 1;
                                                            while ($delivery = $result5->FETCH_ASSOC()) {
                                                                //$from_contact=$delivery["from_contact"];
                                                            ...
                                                            $sql2 = "update base set status1=0 where from_cx_id='$from_cx_id' AND createddate >='$fromdate' AND createddate <='$todate' AND customer_type='party' AND status1!=1 && branch = '$branch' ";
                                                            if (mysqli_query($conn, $sql2)) {
                                                            }
                                                            ?>
                                                        </tbody>
                                                ...
                                                <table style="display:none" class="table table-separate table-head-custom table-checkable" id="kt_datatable2">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $insert = "INSERT into party (id,bill_id,from_cx_id,name,from_contact,from_address,to_address,total1,paymnent,balance,from_date,to_date,branch1,username1,createddate1,partyend_time) 
                                                          values('$id','$bill_id','$from_cx_id','$from_name','$from_contact','$from_address','$to_address','$s','$s1','$s2','$fromdate','$todate','$branch','$username','$createddate','$partyend_time')";
                                                        if (mysqli_query($conn, $insert)) {
                                                            $sql2 = "update base set status1=1,bill_id='$bill_id' where from_cx_id='$from_cx_id' AND createddate >='$fromdate' AND createddate <='$todate' AND customer_type='party' AND status1!=1 && branch = '$branch' ";
                                                            if (mysqli_query($conn, $sql2)) {
                                                            }
                                                        }
                                                        ?>
                                ...
                                <div id="partybill" class="container tab-pane">
                                    <div class="table-responsive">
                                        <table class="table table-separate table-head-custom table-checkable" id="example5">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql5 = "SELECT * FROM party where from_cx_id='$from_cx_id' && branch1 = '$branch' order by bill_id desc";
                                                $result5 = $conn->query($sql5);
                                                $j = 1;
                                                $s = 0;
                                                $s1 = 0;
                                                ...
                                                while ($delivery = $result5->FETCH_ASSOC()) {
                                                    ...
                                                    $sql51 = "SELECT * FROM base where from_cx_id='$from_cx_id' and bill_id='$bill_id' && branch = '$branch' ";
                                                    $result51 = $conn->query($sql51);
                                                    $delivery51 = $result51->FETCH_ASSOC();
                                                    $amount_paid1 = $delivery51["amount_paid1"];

                                                    $sql50 = "SELECT id,from_cx_id,name,from_contact,to_address,mode_payment,amount_enter,payment_date,createdAt11,SUM(total1) as total1,SUM(paymnent) as paymnent,SUM(balance) as balance FROM party where from_cx_id='$from_cx_id' && branch1 = '$branch' GROUP BY name";
                                                    $result50 = $conn->query($sql50);
                                                    while ($delivery50 = $result50->FETCH_ASSOC()) {
                                                        $del =  $delivery50["balance"] - $delivery51["amount_paid1"];
                                        ...
                                        ?>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-separate table-head-custom table-checkable" id="example5">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $sql5 = "SELECT * FROM base where customer_type='party' && from_cx_id='$from_cx_id' && branch = '$branch' and status1=1";
                                                        $result5 = $conn->query($sql5);
                                                        $j = 1;

                                                        while ($delivery = $result5->FETCH_ASSOC()) {

                                                            $sql51 = "SELECT * FROM party where from_cx_id='$from_cx_id' && branch1 = '$branch' ";
                                                            $result51 = $conn->query($sql51);
                                                            $delivery1 = $result51->FETCH_ASSOC();
                                        ...
                                        ?>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-separate table-head-custom table-checkable" id="example5">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $sql5 = "SELECT * FROM base where customer_type='party' && from_cx_id='$from_cx_id' && branch = '$branch'  && createddate >='$fromdate1' AND createddate <='$todate1' and status1=1";
                                                            $result5 = $conn->query($sql5);
                                                            $j = 1;
                                                            while ($delivery = $result5->FETCH_ASSOC()) {
                                                                ...
                                                                $sql50 = "SELECT id,from_cx_id,name,from_contact,to_address,mode_payment,amount_enter,payment_date,payment_date,payment_date,createdAt11,SUM(total1) as total1,SUM(paymnent) as paymnent,SUM(balance) as balance FROM party where from_cx_id='$from_cx_id'' && branch1 = '$branch'  GROUP BY name";
                                                                $result50 = $conn->query($sql50);
                                                                while ($delivery50 = $result50->FETCH_ASSOC()) {
                                                                    $s = 0;
                                                                    $s1 = 0;
                                        ...
                                        ?>
                                            <div class="table-responsive">
                                                <table class="table table-separate table-head-custom table-checkable" id="example5">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $sql5 = "SELECT * FROM base where customer_type='party' && from_cx_id='$from_cx_id' && branch = '$branch'";
                                                        $result5 = $conn->query($sql5);
                                                        $j = 1;
                                                        while ($delivery = $result5->FETCH_ASSOC()) {
                                                        ?>
                                        ...
                                        ?>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-separate table-head-custom table-checkable" id="example5">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $sql5 = "SELECT * FROM base where customer_type='party' && from_cx_id='$from_cx_id' && createddate >='$fromdate3' AND createddate <='$todate3' && branch = '$branch'";
                                                            $result5 = $conn->query($sql5);
                                                            $j = 1;
                                                            while ($delivery = $result5->FETCH_ASSOC()) {
                                                            ?>
                                        ...
                                        ?>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-separate table-head-custom table-checkable" id="example5">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $sql5 = "SELECT * FROM base where customer_type='party' && from_cx_id='$from_cx_id' && status1=0 && branch = '$branch' && username = '$username' order by id desc";
                                                        $result5 = $conn->query($sql5);
                                                        $j = 1;
                                                        $s = 0;
                                                        $s1 = 0;
                                        ...
                                        ?>
                                                ...
                                                <div class="table-responsive" id="productoptClass26">
                                                    <table class="table table-separate table-head-custom table-checkable" id="example7">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $sql9 = "SELECT * FROM base where customer_type='party' && from_cx_id='$from_cx_id' AND status1=0 AND createddate >='$fromdate' AND createddate <='$todate' && branch = '$branch' && username = '$username'";
                                                            $result5 = $conn->query($sql9);
                                                            $j = 1;
                                                            while ($delivery = $result5->FETCH_ASSOC()) {
                                                                //$from_contact=$delivery["from_contact"];
                                                            ...
                                                            $sql2 = "update base set status1=0 where from_cx_id='$from_cx_id' AND createddate >='$fromdate' AND createddate <='$todate' AND customer_type='party' AND status1!=1 && branch = '$branch' && username = '$username'";
                                                            if (mysqli_query($conn, $sql2)) {
                                                            }
                                                            ?>
                                                        </tbody>
                                                ...
                                                <table style="display:none" class="table table-separate table-head-custom table-checkable" id="kt_datatable2">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $insert = "INSERT into party (id,bill_id,from_cx_id,name,from_contact,from_address,to_address,total1,paymnent,balance,from_date,to_date,branch1,username1,createddate1,partyend_time) 
                                                          values('$id','$bill_id','$from_cx_id','$from_name','$from_contact','$from_address','$to_address','$s','$s1','$s2','$fromdate','$todate','$branch','$username','$createddate','$partyend_time')";
                                                        if (mysqli_query($conn, $insert)) {
                                                            $sql2 = "update base set status1=1,bill_id='$bill_id' where from_cx_id='$from_cx_id' AND createddate >='$fromdate' AND createddate <='$todate' AND customer_type='party' AND status1!=1 && branch = '$branch' && username = '$username'";
                                                            if (mysqli_query($conn, $sql2)) {
                                                            }
                                                        }
                                                        ?>
                                        ...
                                        <table class="table table-separate table-head-custom table-checkable" id="example5">
                                            ...
                                            <tbody>
                                                ...
                                                while ($delivery = $result5->FETCH_ASSOC()) {
                                                    ...
                                                    $sql51 = "SELECT * FROM base where from_cx_id='$from_cx_id' and bill_id='$bill_id' && branch = '$branch' && username = '$username'";
                                                    $result51 = $conn->query($sql51);
                                                    $delivery51 = $result51->FETCH_ASSOC();
                                                    $amount_paid1 = $delivery51["amount_paid1"];
                                        ...
                                        ?>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-separate table-head-custom table-checkable" id="example5">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $sql5 = "SELECT * FROM base where customer_type='party' && from_cx_id='$from_cx_id' && branch = '$branch' && username = '$username' and status1=1";
                                                        $result5 = $conn->query($sql5);
                                                        $j = 1;
                                        ...
                                        ?>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-separate table-head-custom table-checkable" id="example5">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $sql5 = "SELECT * FROM base where customer_type='party' && from_cx_id='$from_cx_id' && branch = '$branch' && username = '$username' && createddate >='$fromdate1' AND createddate <='$todate1' and status1=1";
                                                            $result5 = $conn->query($sql5);
                                                            $j = 1;
                                                            while ($delivery = $result5->FETCH_ASSOC()) {
                                                                ...
                                                                $sql50 = "SELECT id,from_cx_id,name,from_contact,to_address,mode_payment,amount_enter,payment_date,payment_date,payment_date,createdAt11,SUM(total1) as total1,SUM(paymnent) as paymnent,SUM(balance) as balance FROM party where from_cx_id='$from_cx_id' && branch1 = '$branch' && username1 = '$username' GROUP BY name";
                                                                $result50 = $conn->query($sql50);
                                                                while ($delivery50 = $result50->FETCH_ASSOC()) {
                                                                    $s = 0;
                                                                    $s1 = 0;
                                        ...
                                        ?>
                                            <div class="table-responsive">
                                                <table class="table table-separate table-head-custom table-checkable" id="example5">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $sql5 = "SELECT * FROM base where customer_type='party' && from_cx_id='$from_cx_id' && branch = '$branch' && username = '$username'";
                                                        $result5 = $conn->query($sql5);
                                                        $j = 1;
                                                        while ($delivery = $result5->FETCH_ASSOC()) {
                                                        ?>
                                        ...
                                        ?>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-separate table-head-custom table-checkable" id="example5">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $sql5 = "SELECT * FROM base where customer_type='party' && from_cx_id='$from_cx_id' && createddate >='$fromdate3' AND createddate <='$todate3' && branch = '$branch' && username = '$username'";
                                                            $result5 = $conn->query($sql5);
                                                            $j = 1;
                                                            while ($delivery = $result5->FETCH_ASSOC()) {
                                                            ?>
...
<script>
    function fnExcelReport5() {
        var tab_text = "<table border='2px'><tr class='col-sm-12 d-flex justify-content-center text-center'><th colspan='12'><h1>&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;APS CARGOS MOVERS&ensp;&ensp;&ensp;</h1></th></tr><tr class='col-sm-12 d-flex justify-content-center text-center'><th colspan='12'><h4>102,WALL TEX ROAD,CHENNAI 600003</h4></th></tr><tr class='col-sm-12 d-flex justify-content-center text-center'><th colspan='12'><h2>TEL NO:- 044-42012933,MOB NO:-9382587896,E-Mail:-apscargo102@gmail.com</h2></th></tr><tr style='bgcolor='#fff82a'>";
        var textRange;
    ...
    $(document).ready(function() {
        $('.allloading_branch').on('click', function() {
            ...
            $.ajax({
                ...
                dataType: "json",
                data: {
                    "action": "partybranchstatus",
                    "id": id
                },
                success: function(result) {
                    alert(result.data.length);
                    $('#allloadingstatusupdate').html('<input type="text" name="bill_id" value="' + id + '"><div class="table-responsive"><table class="table table-separate table-head-custom table-checkable" id="example7"><thead><tr> <th>Name</th><th>Date</th> <th>Total amount</th><th>Amount Paid</th><th>Balance</th> </tr></thead> <tbody><tr>' + result.data[0].from_name + '</tr><tr>' + result.data[0].createdAt + '</tr><tr>' + result.data[0].total + '</tr><tr>' + result.data[0].amount_paid + '</tr><tr>' + result.data[0].balance + '</tr></tbody></table></div>');
                    for (var i = 0; i < result.data.length; i++) {
                        $('#allloadingstatusupdate').append('<tr>' + result.data[i].from_name + '</tr><tr>' + result.data[i].createdAt + '</tr><tr>' + result.data[i].total + '</tr><tr>' + result.data[i].amount_paid + '</tr><tr>' + result.data[i].balance + '</tr>');
                    }
                    $('#allloadingstatusupdate').append('</tbody></table></div>');
...
// <script>
    ...
    // $("#export").on('click', function() {
    //   alert("inside");
    //  window.location.href='lrdatatable.php';
    // });
