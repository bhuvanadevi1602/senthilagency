...
if (isset($_POST['submit'])) {
    ...
    if ($payment_date == "") {
        ...
        $sql2 = "update party set name='$name',balance=balance-'$amount_enter',paymnent=paymnent+'$amount_enter',amount_enter='$amount_enter',mode_payment='$mode_payment',createddate1='$createdat',payment_date='$date' where name='$name' and id='$id'";
            if ($conn->query($sql2)) {
                ...
                $sql1 = "SELECT COUNT(id) as base_count FROM booking_from where from_name='$name'";
                ...
                if ($no > 0) {
                    for ($i = 0; $i < $no; $i++) {
                        ...
                        $sql217 = "SELECT * FROM booking_from WHERE from_name='$name' AND amount_paid1=0 AND bill_id!='' ORDER BY id ASC LIMIT 1";
                        $result27 = $conn->query($sql217);
                        $branchTable = $result27->fetch_assoc();
                        ...
                        if ($amount_paid1 == 0) {
                            ...
                            $sql22 = "update booking_from set amount_paid1='$amount_enter',already_paid1='$amount_enter',pymt_date='$pymtdate'  where id='$id' AND bill_id='$bill_id'";
                            if ($conn->query($sql22)) {
                                $sql17 = "SELECT * FROM add_user WHERE user_name = '$username'";
                                $result17 = $conn->query($sql17);
                                $userTable  = $result17->fetch_assoc();
                                $userBranch = $userTable['courier_mode'];
   ...
   $his="select * from transaction_history order by history_id desc limit 1";
                    ...
                    $bal=$transbalance+$amount_enter;
                                        ...
                                        $sql37 = "INSERT INTO transaction_history (branch_id,user_id,username,party_name,category,Amount,credit,debit,balance,branch_name,mode_payment,description)  
                                                                        VALUES ('$branch_id','$userId','$username','$name','Payments','$amount_enter',$amount_enter,0,'$bal','$userBranch','$mode_payment','Party Paid')";
                                        // $conn->query($sql37);
                            ...
                            if ($conn->query($sql22)) {
                                ...
                                if ($amount_enter) {
                                    ...
                                    if ($conn->query($sql27)) {
                                        ...
                                        $result27 = $conn->query($sql217);
                                        $branchTable = $result27->fetch_assoc();
                                        echo $branch_balance = $branchTable['branch_balance'];
                                        $branch_id = $branchTable['branch_id'];
                                            ...
                                            <div class="card card-custom  example-compact" id="anountenterdetail">
                                                <div class="card-body">
                                                    <div class="form-group row">
                                                        ...
                                                        <input type="datetime-local" value="<?php echo $date ?>" class="form-control" name="payment_date" id="payment_date" placeholder="Enter your LR No" required />
                                                    </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group row">
                                                        ...
                                                        <select class="form-control" name="party11" id="party11">
                                                            <option value="">Select</option>
                                                            <?php
                                                            echo $sql1 = "SELECT * FROM party where branch1 = '$branch' && username1 = '$username' GROUP BY name";
                                                            $result1 = $conn->query($sql1);
                                                            while ($branchTable1 = $result1->fetch_assoc()) {
                                                            ?>
                                                                <option value="<?= $branchTable1['name'] ?> "><?= $branchTable1['name']  ?></option>
            ...
            $.ajax({
                ...
                success: function(result_job) {
                    ...
                    for (var i = 0; i < length; i++) {
                        // alert(result_job.data[i].total1);
                        $('#totalbill'
                            1).val(result_job.data[i].total1);
