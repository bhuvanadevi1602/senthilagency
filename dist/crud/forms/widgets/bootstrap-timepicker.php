...
<div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
	...
	<div class="alert-text">
		...
		<br/>
		For more info please visit the plugin's <a href="http://jdewit.github.io/bootstrap-timepicker/" class="font-weight-bold" target="_blank">Demo Page</a> or <a class="font-weight-bold" href="https://github.com/jdewit/bootstrap-timepicker" target="_blank">Github Repo</a>.
	</div>
</div>
<!--end::Notice-->
					...
					<div class="form-group row">
						...
						<div class="col-lg-9 col-md-9 col-sm-12">
							<div class="input-group timepicker">
								...
								<input class="form-control" id="kt_timepicker_3_modal" readonly placeholder="Select time" type="text"/>
							</div>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-lg-9 col-md-9 col-sm-12">
							<div class="input-group timepicker">
								...
								<input class="form-control" id="kt_timepicker_4_modal" readonly value="10:30:20 AM" type="text"/>
							</div>
						</div>
					</div>
				</div>
