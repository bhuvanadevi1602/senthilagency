...
if (isset($_REQUEST['del']) != "") {
	...
	$sql = "DELETE FROM customer WHERE id='$del'";
	if ($conn->query($sql)) {
	    $sql1 = "DELETE FROM base WHERE from_name='$name'";
	    if ($conn->query($sql1)) {
...
if (isset($_POST['add_customer'])) {
	...
	if ($results->num_rows == 0) {
		$sqls1 = "SELECT * FROM customer WHERE from_cx_id = '$from_cx_id'";
		$results1 = $conn->query($sqls1);
		if ($results1->num_rows == 0) {
			$sql = "insert into customer(from_cx_id,from_name,from_address,from_contact,from_active,branch,username) values('$from_cx_id','$from_name','$from_address','$from_contact','$from_active','$branch','$username')";
...
// 	$sql = "update customer set from_cx_id='$from_cx_id',from_name='$from_name',from_address='$from_address',from_contact='$from_contact' where id=$id";
// 	$result = mysqli_query($conn, $sql);
...
if (isset($_POST['update_customer_address'])) {
	...
	$sql = "update customer set from_cx_id='$from_cx_id',from_name='$from_name',from_address='$from_address',from_contact='$from_contact',from_active='$from_active' where id=$id";
// 	$result = mysqli_query($conn, $sql);
	if ($conn->query($sql)) {
	    $sql = "update base set from_name='$from_name',from_address='$from_address',from_contact='$from_contact',from_active='$from_active' where from_cx_id='$from_cx_id'";
	     if ($conn->query($sql)) {
	          $sql2 = "update party set name='$from_name',from_address='$from_address',from_contact='$from_contact',from_active='$from_active' where from_cx_id='$from_cx_id'";
          	  if ($conn->query($sql2)) {
          	       $sql3 = "update partyexcel set name='$from_name',from_contact='$from_contact',from_active='$from_active' where from_cx_id='$from_cx_id'";
          	       if ($conn->query($sql3)) {
													...
													<div class="container">
														<div class="row">
															<div class="col-12 col-md-10 hh-grayBox pt45 pb20">
																<div class="rows justify-content-center tracking mt-5" id="allpaymentstatusupdate">
									...
									<div class="modal-body">
										<div class="card-body">
											...
											<div class="form-group row">
												...
												<div class="col-lg-9 col-md-9 col-sm-12">
												<select class="form-control" name="from_active" id="from_active">
                                                            <option value="active">Active</option>
                                                            <option value="deactive">De_Active</option>
                                                        </select>
											</div>
											</div>
											...
											<tbody>
												...
												?>
													<tr>
														...
														if($active == 'active' ) {
														?>
                              <td><span class="btn btn-sm btn-light-primary font-weight-bolder" >Active</span></td>
                          <?php
                          } else if($active == 'deactive' ){
                          ?>
                             <td><span  class="btn btn-sm btn-light-danger font-weight-bolder">In Active</span></td>
                             <?php } ?></td>
														<td>
...
<script>
	...
	// 	          $('#kt_datatable3').on('click','.edit_customer',function(){
	// 	          var id=$(this).attr('id');
	// 	          $('#id').val(id);
	...
	$(document).ready(function() {
		$('.allpayment_userstatus').on('click', function() {
			...
			$.ajax({
				...
				success: function(result_job) {
				// 		alert(result_job.data[0].from_active)
				...
				// 	$('#allpaymentstatusupdate').html('<input type="hidden" name="id" value="' + result_job.data[0].id + '"> <div class="form-group row"><div class="col-lg-6 col-sm-12"><input type="hidden" class="form-control" name="from_cx_id" id="from_cx_id" value="' + result_job.data[0].from_cx_id + '" placeholder="Enter customer id" /></div><div class="form-group row"> <label class="col-form-label text-right col-lg-6 col-sm-12">Name<span style="color:red">*</span></label><div class="col-lg-6 col-sm-12"><input type="text" class="form-control" name="from_name" value="' + result_job.data[0].from_name + '" id="from_name" placeholder="Enter Name" /></div></div><div class="form-group row"><label class="col-form-label text-right col-lg-6 col-sm-12">Address<span style="color:red">*</span></label><div class="col-lg-6 col-sm-12"><input type="text" class="form-control" name="from_address" id="from_address" value="' + result_job.data[0].from_address + '" placeholder="Enter Address" /></div></div><div class="form-group row"><label class="col-form-label text-right col-lg-6 col-sm-12">Contact<span style="color:red">*</span></label><div class="col-lg-6 col-sm-12"><input type="text" class="form-control" name="from_contact" id="from_contact" value="' + result_job.data[0].from_contact + '" placeholder="Enter New Contact" /></div></div>');
				$('#allpaymentstatusupdate').html('<input type="hidden" name="id" value="' + result_job.data[0].id + '"><div class="form-group row"><div class="col-lg-6 col-sm-12"><input type="hidden" class="form-control" name="from_cx_id" id="from_cx_id" value="' + result_job.data[0].from_cx_id + '" placeholder="Enter customer id" /></div><div class="form-group row"> <label class="col-form-label text-right col-lg-6 col-sm-12">Name<span style="color:red">*</span></label><div class="col-lg-6 col-sm-12"><input type="text" class="form-control" name="from_name" value="' + result_job.data[0].from_name + '" id="from_name" placeholder="Enter Name" /></div></div><div class="form-group row"><label class="col-form-label text-right col-lg-6 col-sm-12">Address<span style="color:red">*</span></label><div class="col-lg-6 col-sm-12"><input type="text" class="form-control" name="from_address" id="from_address" value="' + result_job.data[0].from_address + '" placeholder="Enter Address" /></div></div><div class="form-group row"><label class="col-form-label text-right col-lg-6 col-sm-12">Contact<span style="color:red">*</span></label><div class="col-lg-6 col-sm-12"><input type="text" class="form-control" name="from_contact" id="from_contact" value="' + result_job.data[0].from_contact + '" placeholder="Enter New Contact" /></div></div><div class="form-group row"><label class="col-form-label text-right col-lg-6 col-sm-12">Status<span style="color:red">*</span></label><div class="col-lg-6 col-sm-12"><select class="form-control" name="from_active" id="from_active"><?php $active = $deactive  = "";switch ("' + result_job.data[0].from_active + '") { case 'active':$active = 'selected'; break;case 'deactive': $deactive = 'selected';break;}?><option value="active" <?php echo $active; ?>>Active</option><option value="deactive" <?php echo $deactive; ?>>Deactive</option></select></div></div>');
