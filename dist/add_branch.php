...
if (isset($_POST['add_branch'])) {
    ...
    $sql = "insert into add_branch(branch_name) values('$branch_name')";
                ...
                <!--begin::Svg Icon | path:assets/media/svg/icons/Tools/Compass.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    <div class="card card-custom">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-form-label text-right col-lg-3 col-sm-12">Branch Name<span style="color:red">*</span></label>
                                                            <div class="col-lg-9 col-md-9 col-sm-12">
                                                                <input type="text" class="form-control" name="branch_name" id="internal_info" placeholder="Enter your Name" />
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" class="btn btn-primary font-weight-bold" name="add_branch">Save</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <div class="card-body">
                            ...
                            <div>
                                <table class="table table-separate table-head-custom table-checkable" id="branch_table">
                                    <thead>
                                        <tr>
                                            <th>Branch ID</th>
                                            <th>Branch Name</th>
    ...
    <script>
        $(document).ready(function() {
            $('#branch_table').DataTable({
                ...
                "responsive": true,
                "ajax": {
                    "url": "ajax_request.php?action=fetch_branch_detail",
                    "type": "POST"
                },
                "columns": [{
                        "data": "branch_id"
        ...
        $(document).ready(function() {
            $('#branch_table').on('click', '.delete_branch', function() {
