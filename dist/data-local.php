...
if(isset($_POST['add_user']))
{
    $name=$_POST['name'];
    $role=$_POST['role'];
    $courier_mode=$_POST['courier'];
    // $active_state=$_POST['active_state'];
    $user_name=$_POST['user_name'];
    $password=$_POST['password'];
     $email=$_POST['email'];
    // print_r($_POST);die();
    $sql="insert into add_user(name,role,courier_mode,active_state,user_name,password) values('$name','$role','$courier_mode',1,'$user_name','$password')";
//  print_r($sql);die();
    $result=mysqli_query($conn,$sql);
    $last_id = mysqli_insert_id($conn);

    	$sql3 = "insert into user_login(name,password,email,active_status,from_cx_id,username,role) values('$name','$password','$email',1,$last_id,'$user_name','user')";
...
if(isset($_POST['update_user']))
{
    ...
    $update_courier_mode=$_POST['courier'];
    $update_active_state=$_POST['active_state'];
    $update_user_name=$_POST['user_name'];
    $update_password=$_POST['password'];
    
    $sql="update add_user set name='$update_name',role='$update_role',courier_mode='$update_courier_mode',active_state='$update_active_state',user_name='$update_user_name',password='$update_password' where user_id=$edit_id ";
    $result=mysqli_query($conn,$sql);
    if($result)
    {
        echo "<script type='text/javascript'>
...
if(isset($_POST['change_password']))
{
    ...
    $sql="update add_user set password='$new_password' where user_id=$id";
    $result=mysqli_query($conn,$sql);
                    ...
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="modal fade" id="create_user_modal" tabindex="-1" role="dialog"
                                ...
                                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" name="user_form" onsubmit="return check()">
                                        ...
                                        <div class="modal-body">
                                            <div class="card-body">
                                                ...
                                                <input type="hidden" class="form-control" name="edit_id"
                                                            id="edit_id" placeholder="Enter your Name" />
                                                <div class="form-group row">
                                                    <label
                                                        class="col-form-label text-right col-lg-3 col-sm-12">Name<span
                                                            style="color:red">*</span></label>
                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                        <input type="text" class="form-control" name="name"
                                                            id="name" placeholder="Enter your Name" />
                                                        <span class="form-text text-muted">We'll never share your
                                                            Username with anyone else.</span>
                                                    </div>
                                                </div>
                                                
                                                <div class="form-group row" id="role_div">
                                                    <label
                                                        class="col-form-label text-right col-lg-3 col-sm-12">Role<span
                                                            style="color:red">*</span></label>
                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                        <span class="form-text text-danger" id="error_element1"></span>
                                                        <select class="form-control" name="role"
                                                            id="role">
                                                            <option selected value="">Select</option>
                                                            <option value="user">User</option>
                                                        </select>
                                                        <span class="form-text text-muted">Please select an
                                                            option.</span>
                                                    </div>
                                                </div>
...
<div class="form-group row">
                                                    <label
                                                        class="col-form-label text-right col-lg-3 col-sm-12">Courier Mode<span
                                                            style="color:red">*</span></label>
                                                           
                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                        <span class="form-text text-danger" id="error_element2"></span>
                                                        <!--<select class="form-control" name="courier_mode"-->
                                                        <!--    id="branch">-->
                                                        <!--    <option selected value="">Select</option>-->
                                                        ...
                                                        <!--    <option  value="Professional">Speed post</option>-->
                                                        <!--    <option  value="ST Courier">ST Courier</option>-->
                                                            
                                                        <!--</select>-->
                                                        
                                                        <select class="selectpicker" style="width:100%" multiple data-live-search="true" class="form-control" name="courier_mode" id="branch">
                                                            <option  value="Delivery">Delivery</option>
                                                            <option  value="DTDC">DTDC</option>
                                                            <option  value="Maruti">Maruti</option>
                                                            <option  value="Professional">Professional</option>
 ...
 <input type="text" class="form-control mt-1" name="courier" id="courier" />
                                                ...
                                                <!--<div class="form-group row">-->
                                                <!--    <label-->
                                                <!--        class="col-form-label text-right col-lg-3 col-sm-12">Active State<span-->
                                                <!--            style="color:red">*</span></label>-->
                                                <!--    <div class="col-lg-9 col-md-9 col-sm-12">-->
                                                <!--        <select class="form-control" name="active_state"-->
                                                <!--            id="active_state">-->
                                                ...
                                                <div class="form-group row">
                                                    <label
                                                        class="col-form-label text-right col-lg-3 col-sm-12">Username<span
                                                            style="color:red">*</span></label>
                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                ...
                                                <!--<div class="form-group row">-->
                                                <!--    <label-->
                                                <!--        class="col-form-label text-right col-lg-3 col-sm-12">Email<span-->
                                                <!--            style="color:red">*</span></label>-->
                                                <!--    <div class="col-lg-9 col-md-9 col-sm-12">-->
                                                ...
                                                <div class="form-group row">
                                                    <label
                                                        class="col-form-label text-right col-lg-3 col-sm-12">Password<span
                                                            style="color:red">*</span></label>
                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                        <input type="text" class="form-control" name="password"
                                                            id="password" placeholder="Enter your Name" />
                                                        <span class="form-text text-muted">We'll never share your
                                                            Username with anyone else.</span>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer" id="modal_footer">
                                           <button type="button" class="btn btn-light-danger font-weight-bold" data-dismiss="modal">Close</button>
                                           	<button type="submit"  class="btn btn-light-primary font-weight-bold mr-2"  name="add_user">Save
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="card-body">
                                                ...
                                                <input type="hidden" class="form-control" name="id"
                                                            id="id" placeholder="Enter your Name" />
                                                
                                                
                                                <div class="form-group row">
                                                    <label
                                                        class="col-form-label text-right col-lg-3 col-sm-12">New Password<span
                                                            style="color:red">*</span></label>
                                                    <div class="col-lg-9 col-md-9 col-sm-12">
                                                        <input type="text" class="form-control" name="new_password"
                                                            id="password" placeholder="Enter New Password" />
                                                        <span class="form-text text-muted">We'll never share your
                                                            Password with anyone else.</span>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer" id="modal_footer">
                                            <button type="button" class="btn btn-light-danger font-weight-bold"
                                            	...
                                            	<button type="submit"  class="btn btn-light-primary font-weight-bold mr-2"  name="change_password">Save
                                            </button>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="footer py-4 d-flex flex-lg-column " id="kt_footer">
        ...
        <div class=" container  d-flex flex-column flex-md-row align-items-center justify-content-between">
            ...
            <div class="text-dark order-2 order-md-1">
                ...
                <a href="#" target="_blank" class="text-dark-75 text-hover-primary">SA</a>
            </div>
            <!--end::Copyright-->
...
<!--            href="https://preview.keenthemes.com/metronic/preview/demo3/builder.html" target="_blank">-->
        ...
        <div class="offcanvas-wrapper mb-5 scroll-pull">
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo ">
                ...
                <div class="overlay-layer">
                    <a href="https://preview.keenthemes.com/metronicdemo1/index.html"
                        class="btn font-weight-bold btn-primary btn-shadow " target="_blank">Default</a>
                    <a href="https://preview.keenthemes.com/metronicdemo1/rtl/index.html"
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo ">
                ...
                <div class="overlay-layer">
                    <a href="https://preview.keenthemes.com/metronicdemo2/index.html"
                        class="btn font-weight-bold btn-primary btn-shadow " target="_blank">Default</a>
                    <a href="https://preview.keenthemes.com/metronicdemo2/rtl/index.html"
                        class="btn btn-light btn-shadow" target="_blank">RTL Version</a>
                </div>
            </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
                ...
                <div class="overlay-layer">
                    <a href="https://preview.keenthemes.com/metronicdemo3/index.html"
                        class="btn font-weight-bold btn-primary btn-shadow " target="_blank">Default</a>
                    <a href="https://preview.keenthemes.com/metronicdemo3/rtl/index.html"
                        class="btn btn-light btn-shadow" target="_blank">RTL Version</a>
                </div>
            </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo ">
                ...
                <div class="overlay-layer">
                    <a href="https://preview.keenthemes.com/metronicdemo4/index.html"
                        class="btn font-weight-bold btn-primary btn-shadow " target="_blank">Default</a>
                    <a href="https://preview.keenthemes.com/metronicdemo4/rtl/index.html"
                        class="btn btn-light btn-shadow" target="_blank">RTL Version</a>
                </div>
            </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo ">
                ...
                <div class="overlay-layer">
                    <a href="https://preview.keenthemes.com/metronicdemo5/index.html"
                        class="btn font-weight-bold btn-primary btn-shadow " target="_blank">Default</a>
                    <a href="https://preview.keenthemes.com/metronicdemo5/rtl/index.html"
                        class="btn btn-light btn-shadow" target="_blank">RTL Version</a>
                </div>
            </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo ">
                ...
                <div class="overlay-layer">
                    <a href="https://preview.keenthemes.com/metronicdemo6/index.html"
                        class="btn font-weight-bold btn-primary btn-shadow " target="_blank">Default</a>
                    <a href="https://preview.keenthemes.com/metronicdemo6/rtl/index.html"
                        class="btn btn-light btn-shadow" target="_blank">RTL Version</a>
                </div>
            </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo ">
                ...
                <div class="overlay-layer">
                    <a href="https://preview.keenthemes.com/metronicdemo7/index.html"
                        class="btn font-weight-bold btn-primary btn-shadow " target="_blank">Default</a>
                    <a href="https://preview.keenthemes.com/metronicdemo7/rtl/index.html"
                        class="btn btn-light btn-shadow" target="_blank">RTL Version</a>
                </div>
            </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo ">
                ...
                <div class="overlay-layer">
                    <a href="https://preview.keenthemes.com/metronicdemo8/index.html"
                        class="btn font-weight-bold btn-primary btn-shadow " target="_blank">Default</a>
                    <a href="https://preview.keenthemes.com/metronicdemo8/rtl/index.html"
                        class="btn btn-light btn-shadow" target="_blank">RTL Version</a>
                </div>
            </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo ">
                ...
                <div class="overlay-layer">
                    <a href="https://preview.keenthemes.com/metronicdemo9/index.html"
                        class="btn font-weight-bold btn-primary btn-shadow " target="_blank">Default</a>
                    <a href="https://preview.keenthemes.com/metronicdemo9/rtl/index.html"
                        class="btn btn-light btn-shadow" target="_blank">RTL Version</a>
                </div>
            </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo ">
                ...
                <div class="overlay-layer">
                    <a href="https://preview.keenthemes.com/metronicdemo10/index.html"
                        class="btn font-weight-bold btn-primary btn-shadow " target="_blank">Default</a>
                    <a href="https://preview.keenthemes.com/metronicdemo10/rtl/index.html"
                        class="btn btn-light btn-shadow" target="_blank">RTL Version</a>
                </div>
            </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo ">
                ...
                <div class="overlay-layer">
                    <a href="https://preview.keenthemes.com/metronicdemo11/index.html"
                        class="btn font-weight-bold btn-primary btn-shadow " target="_blank">Default</a>
                    <a href="https://preview.keenthemes.com/metronicdemo11/rtl/index.html"
                        class="btn btn-light btn-shadow" target="_blank">RTL Version</a>
                </div>
            </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo ">
                ...
                <div class="overlay-layer">
                    <a href="https://preview.keenthemes.com/metronicdemo12/index.html"
                        class="btn font-weight-bold btn-primary btn-shadow " target="_blank">Default</a>
                    <a href="https://preview.keenthemes.com/metronicdemo12/rtl/index.html"
                        class="btn btn-light btn-shadow" target="_blank">RTL Version</a>
                </div>
            </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo ">
                ...
                <div class="overlay-layer">
                    <a href="https://preview.keenthemes.com/metronicdemo13/index.html"
                        class="btn font-weight-bold btn-primary btn-shadow " target="_blank">Default</a>
                    <a href="https://preview.keenthemes.com/metronicdemo13/rtl/index.html"
                        class="btn btn-light btn-shadow" target="_blank">RTL Version</a>
                </div>
            </div>
...
<script>
    $(document).ready(function(){
        $('#user_table').DataTable({
            ...
            "responsive":true,
            "ajax":{
                "url":"ajax_request.php?action=fetch_user_detail",
                "type":"POST"
            },
            "columns":[
                {"data":"user_id"},
            ...
            columnDefs:[
                    ...
                    },
                    {
                      ...
                      render:function(data,type,row){
                          ...
                          {
                              return '<span class="btn btn-sm btn-light-primary font-weight-bolder" >Active</span>';
                          }
                          else if(row.active_state==0)
                          {
                              return '<span  class="btn btn-sm btn-light-danger font-weight-bolder">In Active</span>';
                          }
                      }
                    },
                    {
                      ...
                      render:function(data,type,row){
                          ...
                          {
                              return '<a href="#" id="'+row.user_id+'" class="btn btn-sm btn-clean btn-icon mr-2 edit_user" title="Edit details"><span class="svg-icon svg-icon-md"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"/><path d="M8,17.9148182 L8,5.96685884 C8,5.56391781 8.16211443,5.17792052 8.44982609,4.89581508 L10.965708,2.42895648 C11.5426798,1.86322723 12.4640974,1.85620921 13.0496196,2.41308426 L15.5337377,4.77566479 C15.8314604,5.0588212 16,5.45170806 16,5.86258077 L16,17.9148182 C16,18.7432453 15.3284271,19.4148182 14.5,19.4148182 L9.5,19.4148182 C8.67157288,19.4148182 8,18.7432453 8,17.9148182 Z" fill="#000000" fill-rule="nonzero"\ transform="translate(12.000000, 10.707409) rotate(-135.000000) translate(-12.000000, -10.707409) "/><rect fill="#000000" opacity="0.3" x="5" y="20" width="15" height="2" rx="1"/></g></svg></span></a><div class="dropdown dropdown-inline"><a href="#" class="btn btn-sm btn-clean btn-icon mr-2" data-toggle="dropdown"><span class="svg-icon svg-icon-md"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"/><path d="M5,8.6862915 L5,5 L8.6862915,5 L11.5857864,2.10050506 L14.4852814,5 L19,5 L19,9.51471863 L21.4852814,12 L19,14.4852814 L19,19 L14.4852814,19 L11.5857864,21.8994949 L8.6862915,19 L5,19 L5,15.3137085 L1.6862915,12 L5,8.6862915 Z M12,15 C13.6568542,15 15,13.6568542 15,12 C15,10.3431458 13.6568542,9 12,9 C10.3431458,9 9,10.3431458 9,12 C9,13.6568542 10.3431458,15 12,15 Z" fill="#000000"/></g></svg></span></a><div class="dropdown-menu dropdown-menu-sm dropdown-menu-right"><ul class="navi flex-column navi-hover py-2"><li class="navi-header font-weight-bolder text-uppercase font-size-xs text-primary pb-2">Choose an action:</li><li class="navi-item"><a href="#" id="'+row.user_id+'" class="navi-link change_password"><span class="navi-icon"><i class="fas fa-edit"></i></span><span class="navi-text">Change Password</span></a></li></ul></div></div>';
                          }
                          else
                          {
                              return '<a href="#" id="'+row.user_id+'" class="btn btn-sm btn-clean btn-icon mr-2 edit_user" title="Edit details"><span class="svg-icon svg-icon-md"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"/><path d="M8,17.9148182 L8,5.96685884 C8,5.56391781 8.16211443,5.17792052 8.44982609,4.89581508 L10.965708,2.42895648 C11.5426798,1.86322723 12.4640974,1.85620921 13.0496196,2.41308426 L15.5337377,4.77566479 C15.8314604,5.0588212 16,5.45170806 16,5.86258077 L16,17.9148182 C16,18.7432453 15.3284271,19.4148182 14.5,19.4148182 L9.5,19.4148182 C8.67157288,19.4148182 8,18.7432453 8,17.9148182 Z" fill="#000000" fill-rule="nonzero"\ transform="translate(12.000000, 10.707409) rotate(-135.000000) translate(-12.000000, -10.707409) "/><rect fill="#000000" opacity="0.3" x="5" y="20" width="15" height="2" rx="1"/></g></svg></span></a><a href="#" id="'+row.user_id+'" class="btn btn-sm btn-clean btn-icon delete_user" title="Delete"><span class="svg-icon svg-icon-md"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"/><path d="M6,8 L6,20.5 C6,21.3284271 6.67157288,22 7.5,22 L16.5,22 C17.3284271,22 18,21.3284271 18,20.5 L18,8 L6,8 Z" fill="#000000" fill-rule="nonzero"/><path d="M14,4.5 L14,4 C14,3.44771525 13.5522847,3 13,3 L11,3 C10.4477153,3 10,3.44771525 10,4 L10,4.5 L5.5,4.5 C5.22385763,4.5 5,4.72385763 5,5 L5,5.5 C5,5.77614237 5.22385763,6 5.5,6 L18.5,6 C18.7761424,6 19,5.77614237 19,5.5 L19,5 C19,4.72385763 18.7761424,4.5 18.5,4.5 L14,4.5 Z" fill="#000000" opacity="0.3"/></g></svg></span></a><div class="dropdown dropdown-inline"><a href="#" class="btn btn-sm btn-clean btn-icon mr-2" data-toggle="dropdown"><span class="svg-icon svg-icon-md"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="24" height="24"/><path d="M5,8.6862915 L5,5 L8.6862915,5 L11.5857864,2.10050506 L14.4852814,5 L19,5 L19,9.51471863 L21.4852814,12 L19,14.4852814 L19,19 L14.4852814,19 L11.5857864,21.8994949 L8.6862915,19 L5,19 L5,15.3137085 L1.6862915,12 L5,8.6862915 Z M12,15 C13.6568542,15 15,13.6568542 15,12 C15,10.3431458 13.6568542,9 12,9 C10.3431458,9 9,10.3431458 9,12 C9,13.6568542 10.3431458,15 12,15 Z" fill="#000000"/></g></svg></span></a><div class="dropdown-menu dropdown-menu-sm dropdown-menu-right"><ul class="navi flex-column navi-hover py-2"><li class="navi-header font-weight-bolder text-uppercase font-size-xs text-primary pb-2">Choose an action:</li><li class="navi-item"><a href="#" id="'+row.user_id+'" class="navi-link activate"><span class="navi-icon"><i class="fas fa-user-alt"></i></span><span class="navi-text">Active</span></a></li><li class="navi-item"><a href="#" id="'+row.user_id+'" class="navi-link de_activate"><span class="navi-icon"><i class="fas fa-user-alt-slash"></i></span><span class="navi-text">De-Active</span></a></li><li class="navi-item"><a href="#" id="'+row.user_id+'" class="navi-link change_password"><span class="navi-icon"><i class="fas fa-edit"></i></span><span class="navi-text">Change Password</span></a></li></ul></div></div>';
                          }
        ...
        $('#user_table').on('click','.edit_user',function(){
            ...
            $.ajax({
                ...
                type:"POST",
                dataType:"json",
                data:{"action":"edit_user","edit_id":id},
                success:function(result_job)
                {
                    if(result_job.data[0].role=='super_admin')
                    {
                        $('#role_div').html('');
                    }
                    $('#edit_id').val(result_job.data[0].user_id);
                    $('#name').val(result_job.data[0].name);
                  $('#active_state').val(result_job.data[0].active_state);
               $('#courier').val(result_job.data[0].courier_mode);
                     $('#courier').val(result_job.data[0].courier_mode);
           //  var courier =  var array = $('#courier_mode').val().split(",");
                      $('#role').val(result_job.data[0].role);
                      var role = $('#role').val();
                       $("#select option[value='+role+']").attr('selected', 'selected');
                     $('#user_name').val(result_job.data[0].user_name);
                    $('#password').val(result_job.data[0].password);
                    $('#modal_footer').html('<button type="button" class="btn btn-light-danger font-weight-bold" data-dismiss="modal">Close</button><button type="submit" class="btn btn-primary font-weight-bold"  name="update_user">Update</button>');
                }
            });
        });
        ...
        $('#user_table').on('click','.activate',function(){
            ...
            $.ajax({
                ...
                type:"POST",
                dataType:"json",
                data:{"action":"activate_state","id":id},
                success:function(result_job)
                {
        ...
        $('#user_table').on('click','.de_activate',function(){
            var id=$(this).attr('id');
            $.ajax({
                url:"ajax_request.php",
                type:"POST",
                dataType:"json",
                data:{"action":"de_activate_state","id":id},
                success:function(result_job)
                {
        ...
        $('#user_table').on('click','.change_password',function(){
        ...
        $('#user_table').on('click','.delete_user',function(){
            ...
            Swal.fire({
                ...
                if(e.value)
                {
                    ...
                    type:"POST",
                    dataType:"json",
                    data:{"action":"delete_user","delete_user_id":id},
                    success:function(result_job)
                    {
...
<script>
    function check()
    {
        var role=document.forms['user_form']['role'].value;
        
        if(role=="")
        {
            document.getElementById('error_element1').innerHTML="Role required";
            return false;
        }
        else
        {
            document.getElementById('error_element1').innerHTML="";
        }
        
        var courier_mode=document.forms['user_form']['courier'].value;
        
        if(courier_mode=="")
        {
            document.getElementById('error_element2').innerHTML="Courier Mode required";
            return false;
        }
        else
        {
            document.getElementById('error_element2').innerHTML="";
        }
    }
</script>
</body>
