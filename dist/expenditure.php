                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="text-center"><?php echo $expenditure["expensePerson"] ?></td>
                                                        ...
                                                        <?php } else { ?>
                                                            <?php
                                                            if ($expenditure['expend_time'] > date('Y-m-d h:i:s')) { ?>
                                                                <td class="text-center">
                                                                    <a href="expenditure.php?ex=<?php echo $expenditure["expenditure_id"] ?>&tnuoma=<?php echo $expenditure["amountSpent"] ?>" onclick="myFunction()" class="btn btn-sm btn-clean btn-icon mr-2">
                                                                        <span class="svg-icon svg-icon-danger svg-icon-2x">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="text-center"><?php echo $expenditure["depositsPerson"] ?></td>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="text-center"><?php echo $expenditure["pettyCashPerson"] ?></td>
