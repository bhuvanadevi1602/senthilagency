                        ...
                        <div class="table-responsive" id="productoptClass26">
                          <table class="table table-separate table-head-custom table-checkable" id="example7">
                            ...
                            <tbody>
                              ...
                              $sql2 = "update base set status1=0 where from_name='$from_name' AND createddate >='$fromdate' AND createddate <='$todate' AND customer_type='party' AND status1!=1 ";
                      ...
                      <div class="table-responsive">
                        <table class="table table-separate table-head-custom table-checkable" id="example5">
                          ...
                          <tbody>
                            ...
                            $sql5 = "SELECT * FROM base where customer_type='party' && from_name='$from_name' and status1=1";
                            $result5 = $conn->query($sql5);
                            $j = 1;
                            while ($delivery = $result5->FETCH_ASSOC()) {
                    ...
                    ?>
                        ...
                        <div class="table-responsive">
                          <table class="table table-separate table-head-custom table-checkable" id="example5">
                            ...
                            <tbody>
                              <?php
                              $sql5 = "SELECT * FROM base where customer_type='party' && from_name='$from_name' && createddate >='$fromdate1' AND createddate <='$todate1'  AND status1=1";
                              $result5 = $conn->query($sql5);
                              $j = 1;
                              while ($delivery = $result5->FETCH_ASSOC()) {
                                ...
                                $sql50 = "SELECT id,from_cx_id,name,from_contact,to_address,mode_payment,amount_enter,payment_date,payment_date,payment_date,createdAt11,SUM(total1) as total1,SUM(paymnent) as paymnent,SUM(balance) as balance FROM party where name='$from_name' GROUP BY name";
                                $result50 = $conn->query($sql50);
                                while ($delivery50 = $result50->FETCH_ASSOC()) {
                        ...
                        <div class="table-responsive" id="productoptClass26">
                          <table class="table table-separate table-head-custom table-checkable" id="example7">
                            ...
                            <tbody>
                              ...
                              $sql2 = "update base set status1=0 where from_name='$from_name' AND createddate >='$fromdate' AND createddate <='$todate' AND customer_type='party' AND status1!=1 && branch = '$branch' ";
                              if (mysqli_query($conn, $sql2)) {
                              }
                              ?>
                            </tbody>
                        ...
                        <table style="display:none" class="table table-separate table-head-custom table-checkable" id="kt_datatable2">
                          ...
                          <tbody>
                            ...
                            $insert = "INSERT into party (id,bill_id,from_cx_id,name,from_contact,from_address,to_address,total1,paymnent,balance,from_date,to_date,branch1,username1,createddate1,partyend_time) 
                                                          values('$id','$bill_id','$from_cx_id','$from_name','$from_contact','$from_address','$to_address','$s','$s1','$s2','$fromdate','$todate','$branch','$username','$createddate','$partyend_time')";
                            if (mysqli_query($conn, $insert)) {
                              $sql2 = "update base set status1=1,bill_id='$bill_id' where from_name='$from_name' AND createddate >='$fromdate' AND createddate <='$todate' AND customer_type='party' AND status1!=1 && branch = '$branch' ";
                              if (mysqli_query($conn, $sql2)) {
                              }
                            }
                            ?>
                ...
                <div id="partybill" class="container tab-pane">
                  <div class="table-responsive">
                    <table class="table table-separate table-head-custom table-checkable" id="example5">
                      ...
                      <tbody>
                        <?php
                        $sql5 = "SELECT * FROM party where name='$from_name' && branch1 = '$branch' order by bill_id desc";
                        $result5 = $conn->query($sql5);
                        $j = 1;
                        $s = 0;
                        $s1 = 0;
                    ...
                    ?>
                      ...
                      <div class="table-responsive">
                        <table class="table table-separate table-head-custom table-checkable" id="example5">
                          ...
                          <tbody>
                            <?php
                            $sql5 = "SELECT * FROM base where customer_type='party' && from_name='$from_name' && branch = '$branch' and status1=1";
                            $result5 = $conn->query($sql5);
                            $j = 1;
                    ...
                    ?>
                        ...
                        <div class="table-responsive">
                          <table class="table table-separate table-head-custom table-checkable" id="example5">
                            ...
                            <tbody>
                              <?php
                              $sql5 = "SELECT * FROM base where customer_type='party' && from_name='$from_name' && branch = '$branch'  && createddate >='$fromdate1' AND createddate <='$todate1' and status1=1";
                              $result5 = $conn->query($sql5);
                              $j = 1;
                              while ($delivery = $result5->FETCH_ASSOC()) {
                                ...
                                $sql50 = "SELECT id,from_cx_id,name,from_contact,to_address,mode_payment,amount_enter,payment_date,payment_date,payment_date,createdAt11,SUM(total1) as total1,SUM(paymnent) as paymnent,SUM(balance) as balance FROM party where name='$from_name' && branch1 = '$branch'  GROUP BY name";
                                $result50 = $conn->query($sql50);
                                while ($delivery50 = $result50->FETCH_ASSOC()) {
                                  $s = 0;
                                  $s1 = 0;
                        ...
                        <div class="table-responsive" id="productoptClass26">
                          <table class="table table-separate table-head-custom table-checkable" id="example7">
                            ...
                            <tbody>
                              ...
                              $sql2 = "update base set status1=0 where from_name='$from_name' AND createddate >='$fromdate' AND createddate <='$todate' AND customer_type='party' AND status1!=1 && branch = '$branch' && username = '$username'";
                              if (mysqli_query($conn, $sql2)) {
                              }
                              ?>
                            </tbody>
                        ...
                        <table style="display:none" class="table table-separate table-head-custom table-checkable" id="kt_datatable2">
                          ...
                          <tbody>
                            ...
                            $insert = "INSERT into party (id,bill_id,from_cx_id,name,from_contact,from_address,to_address,total1,paymnent,balance,from_date,to_date,branch1,username1,createddate1,partyend_time) 
                                                          values('$id','$bill_id','$from_cx_id','$from_name','$from_contact','$from_address','$to_address','$s','$s1','$s2','$fromdate','$todate','$branch','$username','$createddate','$partyend_time')";
                            if (mysqli_query($conn, $insert)) {
                              $sql2 = "update base set status1=1,bill_id='$bill_id' where from_name='$from_name' AND createddate >='$fromdate' AND createddate <='$todate' AND customer_type='party' AND status1!=1 && branch = '$branch' && username = '$username'";
                              if (mysqli_query($conn, $sql2)) {
                              }
                            }
                            ?>
                    ...
                    ?>
                      ...
                      <div class="table-responsive">
                        <table class="table table-separate table-head-custom table-checkable" id="example5">
                          ...
                          <tbody>
                            <?php
                            $sql5 = "SELECT * FROM base where customer_type='party' && from_name='$from_name' && branch = '$branch' && username = '$username' and status1=1";
                            $result5 = $conn->query($sql5);
                            $j = 1;
                    ...
                    ?>
                        ...
                        <div class="table-responsive">
                          <table class="table table-separate table-head-custom table-checkable" id="example5">
                            ...
                            <tbody>
                              <?php
                              $sql5 = "SELECT * FROM base where customer_type='party' && from_name='$from_name' && branch = '$branch' && username = '$username' && createddate >='$fromdate1' AND createddate <='$todate1' and status1=1";
                              $result5 = $conn->query($sql5);
                              $j = 1;
                              while ($delivery = $result5->FETCH_ASSOC()) {
...
<script>
  function fnExcelReport1() {
    var tab_text = "<table border='2px'><tr class='col-sm-12 d-flex justify-content-center text-center'><th colspan='14'><h1>&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;APS CARGOS MOVERS&ensp;&ensp;&ensp;</h1></th></tr><tr class='col-sm-12 d-flex justify-content-center text-center'><th colspan='14'><h4>102,WALL TEX ROAD,CHENNAI 600003</h4></th></tr><tr class='col-sm-12 d-flex justify-content-center text-center'><th colspan='14'><h2>TEL NO:- 044-42012933,MOB NO:-9382587896,E-Mail:-apscargo102@gmail.com</h2></th></tr><tr style='bgcolor='#fff82a'>";
    var textRange;
