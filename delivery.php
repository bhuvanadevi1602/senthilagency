...
if(isset($_SESSION["id"])!=0 ){
    ...
    $u_id=$_SESSION["id"];
     ...
     $mob="select * from user_login where name='$name'";
     $exemob=mysqli_query($conn,$mob);
     $valmob=mysqli_fetch_assoc($exemob);
}
          ...
          <div role="tabpanel" id="booking" class="tab-pane">
              <div class="col-12 text-center mb-20">
                    <div class="section-title">
                     ...
                     <div class="container">
						...
						<div class="col-12 col-md-12 hh-grayBox pt45 pb20">
							<div class="row justify-content-between">
								...
								// 	echo $fet['date_time']; 
									$val_009=str_split($fet['updatedAt'],10);
									$date_only=$val_009[0];
                     ...
                     <?php
                //          if($fet['status'] == 0 && $fet['out_status'] != 0 && $fet['In_transit'] == 0 && $fet['rto_status'] == 0 && $fet['notdev_status'] == 0 && $fet['des_status'] == 0)
                //     {
                //           echo "<script> 
