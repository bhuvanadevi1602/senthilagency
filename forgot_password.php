...
if(isset($_POST['reset_password']))
{
    ...
    if($count>0)
    {
        ...
        $headers .= "From: webserve.co.in\r\n";
        $message = "Click the below link to update password <br> <a href='https://udhaarsudhaar.org.in/senthil_agency/update_password.php?user_id=".$rec['id']."'>Update Password</a>";
  $res=mail($to,$subject,$message,$headers);
        if($res)
        {
          
     echo "<script>swal({
  title: 'Password Link Sent To Mail!',
 ...
 text: 'Please Again..',
  ...
  showConfirmButton: false
      ...
      echo "<script>swal({
   title: 'Please Given Correct Gmail ID',
  text: 'Sorry! Not Exist',
 type: 'success',
  timer: 1000,
  showConfirmButton: false
}); </script>";     
            ...
            <div class="row">
                ...
                <!--</div>-->
                 <div class="col-lg-6 pl-lg-5 col-12">
                    ...
                    <div class="about-us-img" style="background-image: url('assets/img/case/3.jpg');background-repeat:no-repeat;background-size: cover;height:320px;">
                    </div>
                     ...
                     <div class="contact-form contact-forms">                                                        
                        <form onsubmit="return validate()" name="register_form" method="post" class="row conact-form">
                            ...
                            <div class="col-md-12 col-12 text-center">
                                <button type="submit" class="theme-btn" name="reset_password">Send Link <i class="fas fa-arrow-right"></i></button>
                            </div>                                      
                        </form>
                    </div>
